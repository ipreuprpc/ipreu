const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AdminDashboard-DdX2GRH5.js","assets/CheckCircleIcon-COCXViU-.js","assets/MemberDashboard-qzRNu385.js"])))=>i.map(i=>d[i]);
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  <defs>
    <radialGradient id="orangeRing" cx="50%" cy="50%" r="50%">
      <stop offset="0%" stop-color="#fdba74" />
      <stop offset="85%" stop-color="#ea580c" />
      <stop offset="100%" stop-color="#9a3412" />
    </radialGradient>
    <radialGradient id="metallicHub" cx="50%" cy="50%" r="50%">
      <stop offset="0%" stop-color="#78716c" />
      <stop offset="40%" stop-color="#44403c" />
    ...
    <path id="topTextPath" d="M 70, 256 A 186,186 0 1,1 442, 256" />
    <path id="bottomTextPath" d="M 70, 256 A 186,186 0 1,0 442, 256" />
    <filter id="3dDeep">
      <feDropShadow dx="0" dy="4" stdDeviation="6" flood-opacity="0.6"/>
    </filter>
  </defs>

  <!-- Outer Metallic Border -->
  <circle cx="256" cy="256" r="254" fill="#1c1917" />
  <circle cx="256" cy="256" r="248" fill="#a8a29e" stroke="#1c1917" stroke-width="1"/>
  
  <!-- Main Orange Band -->
  <circle cx="256" cy="256" r="236" fill="url(#orangeRing)" stroke="#1c1917" stroke-width="4"/>
  <circle cx="256" cy="256" r="184" fill="none" stroke="#1c1917" stroke-width="6"/>

  <!-- Official Typography -->
  <text font-family="Arial Black, Impact, sans-serif" font-weight="950" font-size="28" fill="#000000">
    <textPath href="#topTextPath" startOffset="0%" letter-spacing="-1">INDIANOIL PANIPAT REFINERY</textPath>
    <textPath href="#topTextPath" startOffset="50%" letter-spacing="-1">EMPLOYEES UNION</textPath>
  </text>
  
  <text x="50%" y="415" font-family="Arial Black, sans-serif" font-weight="950" font-size="22" fill="#000000" text-anchor="middle">REGD 1542</text>
  <text x="50%" y="435" font-family="Arial, sans-serif" font-weight="800" font-size="10" fill="#000000" text-anchor="middle" opacity="0.8">AFFILIATED TO B.M.S</text>
  
  <!-- Symmetric Bottom Dots -->
  <circle cx="185" cy="410" r="12" fill="#ffffff" stroke="#000000" stroke-width="2"/>
  <circle cx="327" cy="410" r="12" fill="#ffffff" stroke="#000000" stroke-width="2"/>

  <!-- Inner Metallic Hub with Sunburst -->
  <circle cx="256" cy="256" r="172" fill="url(#metallicHub)" stroke="#1c1917" stroke-width="4"/>
  <g opacity="0.3" transform="translate(256,256)">
    ${Array.from({length:16}).map((n,e)=>`
      <polygon points="0,-165 8,-80 -8,-80" fill="#ffffff" transform="rotate(${e*22.5})" />
    `).join("")}
  </g>

  <!-- Central Star Frame -->
  <polygon points="256,115 292,205 390,215 315,275 345,370 256,320 167,370 197,275 122,215 220,205" 
           fill="url(#goldStar)" stroke="#000000" stroke-width="2" filter="url(#3dDeep)"/>
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nw{constructor(e,t,i,o,l=!1){this.auth=e,this.resolver=i,this.user=o,this.bypassAuthState=l,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:i,postBody:o,tenantId:l,error:h,type:f}=e;if(h){this.reject(h);return}const g={auth:this.auth,requestUri:t,sessionId:i,tenantId:l||void 0,postBody:o||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(f)(g))}catch(y){this.reject(y)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return LA;case"linkViaPopup":case"linkViaRedirect":return FA;case"reauthViaPopup":case"reauthViaRedirect":return MA;default:$n(this.auth,"internal-error")}}resolve(e){Wr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Wr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const KA=600*1e3;class GA{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach(i=>{this.isEventForConsumer(e,i)&&(t=!0,this.sendToConsumer(e,i),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!QA(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){var i;if(e.error&&!rw(e)){const o=((i=e.error.code)==null?void 0:i.split("auth/")[1])||"internal-error";t.onError(hr(this.auth,o))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const i=t.eventId===null||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&i}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=KA&&this.cachedEventUids.clear(),this.cachedEventUids.has(Ny(e))}saveEventToCache(e){this.cachedEventUids.add(Ny(e)),this.lastProcessedEventTime=Date.now()}}function Ny(n){return[n.type,n.eventId,n.sessionId,n.tenantId].filter(e=>e).join("-")}function rw({type:n,error:e}){return n==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function QA(n){switch(n.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return rw(n);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function AR(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function RR(n){zn(new xn("auth",(e,{options:t})=>{const i=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),l=e.getProvider("app-check-internal"),{apiKey:h,authDomain:f}=i.options;me(h&&!h.includes(":"),"invalid-api-key",{appName:i.name});const g={apiKey:h,authDomain:f,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:jv(n)},y=new qS(i,o,l,g);return eA(y,t),y},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,i)=>{e.getProvider("auth-internal").initialize()})),zn(new xn("auth-internal",e=>{const t=Us(e.getProvider("auth").getImmediate());return(i=>new SR(i))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),rn(Vy,Ly,AR(n)),rn(Vy,Ly,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kR=300,xR=mv("authIdTokenMaxAge")||kR;let My=null;const CR=n=>async e=>{const t=e&&await e.getIdTokenResult(),i=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(i&&i>xR)return;const o=t==null?void 0:t.token;My!==o&&(My=o,await fetch(n,{method:o?"POST":"DELETE",headers:o?{Authorization:`Bearer ${o}`}:{}}))};function PR(n=Bc()){const e=Ms(n,"auth");if(e.isInitialized())return e.getImmediate();const t=ZS(n,{popupRedirectResolver:IR,persistence:[OA,TA,Jv]}),i=mv("authTokenSyncURL");if(i&&typeof isSecureContext=="boolean"&&isSecureContext){const l=new URL(i,location.origin);if(location.origin===l.origin){const h=CR(l.toString());_A(t,h,()=>h(t.currentUser)),yA(t,f=>h(f))}}const o=dv("auth");return o&&tA(t,`http://${o}`),t}function NR(){var n;return((n=document.getElementsByTagName("head"))==null?void 0:n[0])??document}HS({loadJS(n){return new Promise((e,t)=>{const i=document.createElement("script");i.setAttribute("src",n),i.onload=e,i.onerror=o=>{const l=hr("internal-error");l.customData=o,t(l)},i.type="text/javascript",i.charset="UTF-8",NR().appendChild(i)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});RR("Browser");const iw="@firebase/installations",Qf="0.6.21";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sw=1e4,ow=`w:${Qf}`,aw="FIS_v2",bR="https://firebaseinstallations.googleapis.com/v1",DR=3600*1e3,OR="installations",VR="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jR({appConfig:n,heartbeatServiceProvider:e},{fid:t}){const i=uw(n),o=dw(n),l=e.getImmediate({optional:!0});if(l){const y=await l.getHeartbeatsHeader();y&&o.append("x-firebase-client",y)}const h={fid:t,authVersion:aw,appId:n.appId,sdkVersion:ow},f={method:"POST",headers:o,body:JSON.stringify(h)},g=await fw(()=>fetch(i,f));if(g.ok){const y=await g.json();return{fid:y.fid||t,registrationStatus:2,refreshToken:y.refreshToken,authToken:cw(y.authToken)}}else throw await hw("Create Installation",g)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mw=new Map;function gw(n,e){const t=Hc(n);yw(t,e),HR(t,e)}function yw(n,e){const t=mw.get(n);if(t)for(const i of t)i(e)}function HR(n,e){const t=WR();t&&t.postMessage({key:n,fid:e}),KR()}let Ts=null;function WR(){return!Ts&&"BroadcastChannel"in self&&(Ts=new BroadcastChannel("[Firebase] FID Change"),Ts.onmessage=n=>{yw(n.data.key,n.data.fid)}),Ts}function KR(){mw.size===0&&Ts&&(Ts.close(),Ts=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const GR="firebase-installations-database",QR=1,Ns="firebase-installations-store";let Jd=null;function Yf(){return Jd||(Jd=jc(GR,QR,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(Ns)}}})),Jd}async function Sc(n,e){const t=Hc(n),o=(await Yf()).transaction(Ns,"readwrite"),l=o.objectStore(Ns),h=await l.get(t);return await l.put(e,t),await o.done,(!h||h.fid!==e.fid)&&gw(n,e.fid),e}async function _w(n){const e=Hc(n),i=(await Yf()).transaction(Ns,"readwrite");await i.objectStore(Ns).delete(e),await i.done}async function Wc(n,e){const t=Hc(n),o=(await Yf()).transaction(Ns,"readwrite"),l=o.objectStore(Ns),h=await l.get(t),f=e(h);return f===void 0?await l.delete(t):await l.put(f,t),await o.done,f&&(!h||h.fid!==f.fid)&&gw(n,f.fid),f}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Jf(n){let e;const t=await Wc(n.appConfig,i=>{const o=YR(i),l=JR(n,o);return e=l.registrationPromise,l.installationEntry});return t.fid===_f?{installationEntry:await e}:{installationEntry:t,registrationPromise:e}}function YR(n){const e=n||{fid:$R(),registrationStatus:0};return vw(e)}function JR(n,e){if(e.registrationStatus===0){if(!navigator.onLine){const o=Promise.reject(Ps.create("app-offline"));return{installationEntry:e,registrationPromise:o}}const t={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},i=XR(n,t);return{installationEntry:t,registrationPromise:i}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:ZR(n)}:{installationEntry:e}}async function XR(n,e){try{const t=await jR(n,e);return Sc(n.appConfig,t)}catch(t){throw lw(t)&&t.customData.serverCode===409?await _w(n.appConfig):await Sc(n.appConfig,{fid:e.fid,registrationStatus:0}),t}}async function ZR(n){let e=await Fy(n.appConfig);for(;e.registrationStatus===1;)await pw(100),e=await Fy(n.appConfig);if(e.registrationStatus===0){const{installationEntry:t,registrationPromise:i}=await Jf(n);return i||t}return e}function Fy(n){return Wc(n,e=>{if(!e)throw Ps.create("installation-not-found");return vw(e)})}function vw(n){return e1(n)?{fid:n.fid,registrationStatus:0}:n}function e1(n){return n.registrationStatus===1&&n.registrationTime+sw<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function t1({appConfig:n,heartbeatServiceProvider:e},t){const i=n1(n,t),o=MR(n,t),l=e.getImmediate({optional:!0});if(l){const y=await l.getHeartbeatsHeader();y&&o.append("x-firebase-client",y)}const h={installation:{sdkVersion:ow,appId:n.appId}},f={method:"POST",headers:o,body:JSON.stringify(h)},g=await fw(()=>fetch(i,f));if(g.ok){const y=await g.json();return cw(y)}else throw await hw("Generate Auth Token",g)}function n1(n,{fid:e}){return`${uw(n)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xf(n,e=!1){let t;const i=await Wc(n.appConfig,l=>{if(!ww(l))throw Ps.create("not-registered");const h=l.authToken;if(!e&&s1(h))return l;if(h.requestStatus===1)return t=r1(n,e),l;{if(!navigator.onLine)throw Ps.create("app-offline");const f=a1(l);return t=i1(n,f),f}});return t?await t:i.authToken}async function r1(n,e){let t=await Uy(n.appConfig);for(;t.authToken.requestStatus===1;)await pw(100),t=await Uy(n.appConfig);const i=t.authToken;return i.requestStatus===0?Xf(n,e):i}function Uy(n){return Wc(n,e=>{if(!ww(e))throw Ps.create("not-registered");const t=e.authToken;return l1(t)?{...e,authToken:{requestStatus:0}}:e})}async function i1(n,e){try{const t=await t1(n,e),i={...e,authToken:t};return await Sc(n.appConfig,i),t}catch(t){if(lw(t)&&(t.customData.serverCode===401||t.customData.serverCode===404))await _w(n.appConfig);else{const i={...e,authToken:{requestStatus:0}};await Sc(n.appConfig,i)}throw t}}function ww(n){return n!==void 0&&n.registrationStatus===2}function s1(n){return n.requestStatus===2&&!o1(n)}function o1(n){const e=Date.now();return e<n.creationTime||n.creationTime+n.expiresIn<e+DR}function a1(n){const e={requestStatus:1,requestTime:Date.now()};return{...n,authToken:e}}function l1(n){return n.requestStatus===1&&n.requestTime+sw<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ew="installations",f1="installations-internal",p1=n=>{const e=n.getProvider("app").getImmediate(),t=d1(e),i=Ms(e,"heartbeat");return{app:e,appConfig:t,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()}},m1=n=>{const e=n.getProvider("app").getImmediate(),t=Ms(e,Ew).getImmediate();return{getId:()=>u1(t),getToken:o=>c1(t,o)}};function g1(){zn(new xn(Ew,p1,"PUBLIC")),zn(new xn(f1,m1,"PRIVATE"))}g1();rn(iw,Qf);rn(iw,Qf,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const y1="/firebase-messaging-sw.js",_1="/firebase-cloud-messaging-push-scope",Tw="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",v1="https://fcmregistrations.googleapis.com/v1",Iw="google.c.a.c_id",w1="google.c.a.c_l",E1="google.c.a.ts",T1="google.c.a.e",jy=1e4;var By;(function(n){n[n.DATA_MESSAGE=1]="DATA_MESSAGE",n[n.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(By||(By={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const k1="firebase-messaging-database",x1=1,fl="firebase-messaging-store";let ef=null;function Sw(){return ef||(ef=jc(k1,x1,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(fl)}}})),ef}async function C1(n){const e=Aw(n),i=await(await Sw()).transaction(fl).objectStore(fl).get(e);if(i)return i;{const o=await A1(n.appConfig.senderId);if(o)return await Zf(n,o),o}}async function Zf(n,e){const t=Aw(n),o=(await Sw()).transaction(fl,"readwrite");return await o.objectStore(fl).put(e,t),await o.done,e}function Aw({appConfig:n}){return n.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function z1(n){return typeof n=="object"&&!!n&&Iw in n}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function G1(n,e){e?n.vapidKey=e:n.vapidKey||(n.vapidKey=Tw)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function kw(n,e){if(!navigator)throw Ht.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw Ht.create("permission-blocked");return await G1(n,e==null?void 0:e.vapidKey),await K1(n,e==null?void 0:e.serviceWorkerRegistration),V1(n)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ge(n,e,t){let i="Unexpected state";typeof e=="string"?i=e:t=e,Ow(n,i,t)}function Ow(n,e,t){let i=`FIRESTORE (${Go}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{i+=" CONTEXT: "+JSON.stringify(t)}catch{i+=" CONTEXT: "+t}throw Kr(i),new Error(i)}function qe(n,e,t,i){let o="Unexpected state";typeof t=="string"?o=t:i=t,n||Ow(e,o,i)}function Ie(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fw="";function Ak(n){let e="";for(let t=0;t<n.length;t++)e.length>0&&(e=e_(e)),e=Rk(n.get(t),e);return e_(e)}function Rk(n,e){let t=e;const i=n.length;for(let o=0;o<i;o++){const l=n.charAt(o);switch(l){case"\0":t+="";break;case Fw:t+="";break;default:t+=l}}return t}function e_(n){return n+Fw+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function t_(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function Hi(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function Uw(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bw="server_timestamp",zw="__type__",$w="__previous_value__",qw="__local_write_time__";function sp(n){var t,i;return((i=(((t=n==null?void 0:n.mapValue)==null?void 0:t.fields)||{})[zw])==null?void 0:i.stringValue)===Bw}function Yc(n){const e=n.mapValue.fields[$w];return sp(e)?Yc(e):e}function ml(n){const e=Fi(n.mapValue.fields[qw].timestampValue);return new Ze(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gw{}class _t extends Gw{constructor(e,t,i){super(),this.field=e,this.op=t,this.value=i}static create(e,t,i){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,i):new Vk(e,t,i):t==="array-contains"?new Fk(e,i):t==="in"?new Uk(e,i):t==="not-in"?new jk(e,i):t==="array-contains-any"?new Bk(e,i):new _t(e,t,i)}static createKeyFieldInFilter(e,t,i){return t==="in"?new Lk(e,i):new Mk(e,i)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&t.nullValue===void 0&&this.matchesComparison(zo(t,this.value)):t!==null&&ji(this.value)===ji(t)&&this.matchesComparison(zo(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return ge(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class qn extends Gw{constructor(e,t){super(),this.filters=e,this.op=t,this.Pe=null}static create(e,t){return new qn(e,t)}matches(e){return Qw(this)?this.filters.find((t=>!t.matches(e)))===void 0:this.filters.find((t=>t.matches(e)))!==void 0}getFlattenedFilters(){return this.Pe!==null||(this.Pe=this.filters.reduce(((e,t)=>e.concat(t.getFlattenedFilters())),[])),this.Pe}getFilters(){return Object.assign([],this.filters)}}function Qw(n){return n.op==="and"}function Yw(n){return Ok(n)&&Qw(n)}function Ok(n){for(const e of n.filters)if(e instanceof qn)return!1;return!0}function If(n){if(n instanceof _t)return n.field.canonicalString()+n.op.toString()+$o(n.value);if(Yw(n))return n.filters.map((e=>If(e))).join(",");{const e=n.filters.map((t=>If(t))).join(",");return`${n.op}(${e})`}}function Jw(n,e){return n instanceof _t?(function(i,o){return o instanceof _t&&i.op===o.op&&i.field.isEqual(o.field)&&gr(i.value,o.value)})(n,e):n instanceof qn?(function(i,o){return o instanceof qn&&i.op===o.op&&i.filters.length===o.filters.length?i.filters.reduce(((l,h,f)=>l&&Jw(h,o.filters[f])),!0):!1})(n,e):void ge(19439)}function Xw(n){return n instanceof _t?(function(t){return`${t.field.canonicalString()} ${t.op} ${$o(t.value)}`})(n):n instanceof qn?(function(t){return t.op.toString()+" {"+t.getFilters().map(Xw).join(" ,")+"}"})(n):"Filter"}class Vk extends _t{constructor(e,t,i){super(e,t,i),this.key=ce.fromName(i.referenceValue)}matches(e){const t=ce.comparator(e.key,this.key);return this.matchesComparison(t)}}class Lk extends _t{constructor(e,t){super(e,"in",t),this.keys=Zw("in",t)}matches(e){return this.keys.some((t=>t.isEqual(e.key)))}}class Mk extends _t{constructor(e,t){super(e,"not-in",t),this.keys=Zw("not-in",t)}matches(e){return!this.keys.some((t=>t.isEqual(e.key)))}}function Zw(n,e){var t;return(((t=e.arrayValue)==null?void 0:t.values)||[]).map((i=>ce.fromName(i.referenceValue)))}class Fk extends _t{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return op(t)&&yl(t.arrayValue,this.value)}}class Uk extends _t{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&yl(this.value.arrayValue,t)}}class jk extends _t{constructor(e,t){super(e,"not-in",t)}matches(e){if(yl(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&t.nullValue===void 0&&!yl(this.value.arrayValue,t)}}class Bk extends _t{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!op(t)||!t.arrayValue.values)&&t.arrayValue.values.some((i=>yl(this.value.arrayValue,i)))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class js{constructor(e,t){this.mapKeyFn=e,this.equalsFn=t,this.inner={},this.innerSize=0}get(e){const t=this.mapKeyFn(e),i=this.inner[t];if(i!==void 0){for(const[o,l]of i)if(this.equalsFn(o,e))return l}}has(e){return this.get(e)!==void 0}set(e,t){const i=this.mapKeyFn(e),o=this.inner[i];if(o===void 0)return this.inner[i]=[[e,t]],void this.innerSize++;for(let l=0;l<o.length;l++)if(this.equalsFn(o[l][0],e))return void(o[l]=[e,t]);o.push([e,t]),this.innerSize++}delete(e){const t=this.mapKeyFn(e),i=this.inner[t];if(i===void 0)return!1;for(let o=0;o<i.length;o++)if(this.equalsFn(i[o][0],e))return i.length===1?delete this.inner[t]:i.splice(o,1),this.innerSize--,!0;return!1}forEach(e){Hi(this.inner,((t,i)=>{for(const[o,l]of i)e(o,l)}))}isEmpty(){return Uw(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function up(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Ac(e)?"-0":e}}function o0(n){return{integerValue:""+n}}function a0(n,e){return Sk(e)?o0(e):up(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eh{constructor(){this._=void 0}}function ex(n,e,t){return n instanceof Pc?(function(o,l){const h={fields:{[zw]:{stringValue:Bw},[qw]:{timestampValue:{seconds:o.seconds,nanos:o.nanoseconds}}}};return l&&sp(l)&&(l=Yc(l)),l&&(h.fields[$w]=l),{mapValue:h}})(t,e):n instanceof vl?u0(n,e):n instanceof wl?c0(n,e):(function(o,l){const h=l0(o,l),f=d_(h)+d_(o.Ae);return Tf(h)&&Tf(o.Ae)?o0(f):up(o.serializer,f)})(n,e)}function tx(n,e,t){return n instanceof vl?u0(n,e):n instanceof wl?c0(n,e):t}function l0(n,e){return n instanceof El?(function(i){return Tf(i)||(function(l){return!!l&&"doubleValue"in l})(i)})(e)?e:{integerValue:0}:null}class Pc extends eh{}class vl extends eh{constructor(e){super(),this.elements=e}}function u0(n,e){const t=h0(e);for(const i of n.elements)t.some((o=>gr(o,i)))||t.push(i);return{arrayValue:{values:t}}}class wl extends eh{constructor(e){super(),this.elements=e}}function c0(n,e){let t=h0(e);for(const i of n.elements)t=t.filter((o=>!gr(o,i)));return{arrayValue:{values:t}}}class El extends eh{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function d_(n){return dt(n.integerValue||n.doubleValue)}function h0(n){return op(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */tn.DEFAULT_COLLECTION_PERCENTILE=10,tn.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,tn.DEFAULT=new tn(A0,tn.DEFAULT_COLLECTION_PERCENTILE,tn.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),tn.DISABLED=new tn(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Os="RemoteStore";class EC{constructor(e,t,i,o,l){this.localStore=e,this.datastore=t,this.asyncQueue=i,this.remoteSyncer={},this.Ta=[],this.Ea=new Map,this.Ia=new Set,this.Ra=[],this.Aa=l,this.Aa.Mo((h=>{i.enqueueAndForget((async()=>{Bs(this)&&(ne(Os,"Restarting streams for network reachability change."),await(async function(g){const y=Ie(g);y.Ia.add(4),await Pl(y),y.Va.set("Unknown"),y.Ia.delete(4),await ih(y)})(this))}))})),this.Va=new wC(i,o)}}async function ih(n){if(Bs(n))for(const e of n.Ra)await e(!0)}async function Pl(n){for(const e of n.Ra)await e(!1)}function N0(n,e){const t=Ie(n);t.Ea.has(e.targetId)||(t.Ea.set(e.targetId,e),Ep(t)?wp(t):Xo(t).O_()&&vp(t,e))}function _p(n,e){const t=Ie(n),i=Xo(t);t.Ea.delete(e),i.O_()&&b0(t,e),t.Ea.size===0&&(i.O_()?i.L_():Bs(t)&&t.Va.set("Unknown"))}function vp(n,e){if(n.da.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(we.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}Xo(n).Z_(e)}function b0(n,e){n.da.$e(e),Xo(n).X_(e)}function wp(n){n.da=new px({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),At:e=>n.Ea.get(e)||null,ht:()=>n.datastore.serializer.databaseId}),Xo(n).start(),n.Va.ua()}function Ep(n){return Bs(n)&&!Xo(n).x_()&&n.Ea.size>0}function Bs(n){return Ie(n).Ia.size===0}function D0(n){n.da=void 0}async function TC(n){n.Va.set("Online")}async function IC(n){n.Ea.forEach(((e,t)=>{vp(n,e)}))}async function SC(n,e){D0(n),Ep(n)?(n.Va.ha(e),wp(n)):n.Va.set("Unknown")}async function AC(n,e,t){if(n.Va.set("Online"),e instanceof g0&&e.state===2&&e.cause)try{await(async function(o,l){const h=l.cause;for(const f of l.targetIds)o.Ea.has(f)&&(await o.remoteSyncer.rejectListen(f,h),o.Ea.delete(f),o.da.removeTarget(f))})(n,e)}catch(i){ne(Os,"Failed to remove targets %s: %s ",e.targetIds.join(","),i),await Dc(n,i)}else if(e instanceof pc?n.da.Xe(e):e instanceof m0?n.da.st(e):n.da.tt(e),!t.isEqual(we.min()))try{const i=await x0(n.localStore);t.compareTo(i)>=0&&await(function(l,h){const f=l.da.Tt(h);return f.targetChanges.forEach(((g,y)=>{if(g.resumeToken.approximateByteSize()>0){const w=l.Ea.get(y);w&&l.Ea.set(y,w.withResumeToken(g.resumeToken,h))}})),f.targetMismatches.forEach(((g,y)=>{const w=l.Ea.get(g);if(!w)return;l.Ea.set(g,w.withResumeToken(Vt.EMPTY_BYTE_STRING,w.snapshotVersion)),b0(l,g);const A=new bi(w.target,g,y,w.sequenceNumber);vp(l,A)})),l.remoteSyncer.applyRemoteEvent(f)})(n,t)}catch(i){ne(Os,"Failed to raise snapshot:",i),await Dc(n,i)}}async function Dc(n,e,t){if(!Yo(e))throw e;n.Ia.add(1),await Pl(n),n.Va.set("Offline"),t||(t=()=>x0(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{ne(Os,"Retrying IndexedDB access"),await t(),n.Ia.delete(1),await ih(n)}))}function O0(n,e){return e().catch((t=>Dc(n,t,e)))}async function sh(n){const e=Ie(n),t=Bi(e);let i=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:ip;for(;RC(e);)try{const o=await oC(e.localStore,i);if(o===null){e.Ta.length===0&&t.L_();break}i=o.batchId,kC(e,o)}catch(o){await Dc(e,o)}V0(e)&&L0(e)}function RC(n){return Bs(n)&&n.Ta.length<10}function kC(n,e){n.Ta.push(e);const t=Bi(n);t.O_()&&t.Y_&&t.ea(e.mutations)}function V0(n){return Bs(n)&&!Bi(n).x_()&&n.Ta.length>0}function L0(n){Bi(n).start()}async function xC(n){Bi(n).ra()}async function CC(n){const e=Bi(n);for(const t of n.Ta)e.ea(t.mutations)}async function PC(n,e,t){const i=n.Ta.shift(),o=hp.from(i,e,t);await O0(n,(()=>n.remoteSyncer.applySuccessfulWrite(o))),await sh(n)}async function NC(n,e){e&&Bi(n).Y_&&await(async function(i,o){if((function(h){return hx(h)&&h!==z.ABORTED})(o.code)){const l=i.Ta.shift();Bi(i).B_(),await O0(i,(()=>i.remoteSyncer.rejectFailedWrite(l.batchId,o))),await sh(i)}})(n,e),V0(n)&&L0(n)}async function C_(n,e){const t=Ie(n);t.asyncQueue.verifyOperationInProgress(),ne(Os,"RemoteStore received new credentials");const i=Bs(t);t.Ia.add(3),await Pl(t),i&&t.Va.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ia.delete(3),await ih(t)}async function bC(n,e){const t=Ie(n);e?(t.Ia.delete(2),await ih(t)):e||(t.Ia.add(2),await Pl(t),t.Va.set("Unknown"))}function Xo(n){return n.ma||(n.ma=(function(t,i,o){const l=Ie(t);return l.sa(),new mC(i,l.connection,l.authCredentials,l.appCheckCredentials,l.serializer,o)})(n.datastore,n.asyncQueue,{Zo:TC.bind(null,n),Yo:IC.bind(null,n),t_:SC.bind(null,n),H_:AC.bind(null,n)}),n.Ra.push((async e=>{e?(n.ma.B_(),Ep(n)?wp(n):n.Va.set("Unknown")):(await n.ma.stop(),D0(n))}))),n.ma}function Bi(n){return n.fa||(n.fa=(function(t,i,o){const l=Ie(t);return l.sa(),new gC(i,l.connection,l.authCredentials,l.appCheckCredentials,l.serializer,o)})(n.datastore,n.asyncQueue,{Zo:()=>Promise.resolve(),Yo:xC.bind(null,n),t_:NC.bind(null,n),ta:CC.bind(null,n),na:PC.bind(null,n)}),n.Ra.push((async e=>{e?(n.fa.B_(),await sh(n)):(await n.fa.stop(),n.Ta.length>0&&(ne(Os,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))}))),n.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lP="ComponentProvider",L_=new Map;function uP(n,e,t,i,o){return new xk(n,e,t,o.host,o.ssl,o.experimentalForceLongPolling,o.experimentalAutoDetectLongPolling,W0(o.experimentalLongPollingOptions),o.useFetchStreams,o.isUsingEmulator,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fP=/^__.*__$/;class pP{constructor(e,t,i){this.data=e,this.fieldMask=t,this.fieldTransforms=i}toMutation(e,t){return this.fieldMask!==null?new Wi(e,this.data,this.fieldMask,t,this.fieldTransforms):new xl(e,this.data,t,this.fieldTransforms)}}class G0{constructor(e,t,i){this.data=e,this.fieldMask=t,this.fieldTransforms=i}toMutation(e,t){return new Wi(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function Q0(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw ge(40011,{dataSource:n})}}class bp{constructor(e,t,i,o,l,h){this.settings=e,this.databaseId=t,this.serializer=i,this.ignoreUndefinedProperties=o,l===void 0&&this.Ac(),this.fieldTransforms=l||[],this.fieldMask=h||[]}get path(){return this.settings.path}get dataSource(){return this.settings.dataSource}i(e){return new bp({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}dc(e){var o;const t=(o=this.path)==null?void 0:o.child(e),i=this.i({path:t,arrayElement:!1});return i.mc(e),i}fc(e){var o;const t=(o=this.path)==null?void 0:o.child(e),i=this.i({path:t,arrayElement:!1});return i.Ac(),i}gc(e){return this.i({path:void 0,arrayElement:!0})}yc(e){return Lc(e,this.settings.methodName,this.settings.hasConverter||!1,this.path,this.settings.targetDoc)}contains(e){return this.fieldMask.find((t=>e.isPrefixOf(t)))!==void 0||this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))!==void 0}Ac(){if(this.path)for(let e=0;e<this.path.length;e++)this.mc(this.path.get(e))}mc(e){if(e.length===0)throw this.yc("Document fields must not be empty");if(Q0(this.dataSource)&&fP.test(e))throw this.yc('Document fields cannot begin and end with "__"')}}class mP{constructor(e,t,i){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=i||rh(e)}A(e,t,i,o=!1){return new bp({dataSource:e,methodName:t,targetDoc:i,path:Ot.emptyPath(),arrayElement:!1,hasConverter:o},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function uh(n){const e=n._freezeSettings(),t=rh(n._databaseId);return new mP(n._databaseId,!!e.ignoreUndefinedProperties,t)}function Y0(n,e,t,i,o,l={}){const h=n.A(l.merge||l.mergeFields?2:0,e,t,o);Op("Data must be an object, but it was:",h,i);const f=J0(i,h);let g,y;if(l.merge)g=new yn(h.fieldMask),y=h.fieldTransforms;else if(l.mergeFields){const w=[];for(const A of l.mergeFields){const N=Vs(e,A,t);if(!h.contains(N))throw new ee(z.INVALID_ARGUMENT,`Field '${N}' is specified in your field mask but missing from your input data.`);eE(w,N)||w.push(N)}g=new yn(w),y=h.fieldTransforms.filter((A=>g.covers(A.field)))}else g=null,y=h.fieldTransforms;return new pP(new nn(f),g,y)}class ch extends lh{_toFieldTransform(e){if(e.dataSource!==2)throw e.dataSource===1?e.yc(`${this._methodName}() can only appear at the top level of your update data`):e.yc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof ch}}class Dp extends lh{constructor(e,t){super(e),this.bc=t}_toFieldTransform(e){const t=new El(e.serializer,a0(e.serializer,this.bc));return new nx(e.path,t)}isEqual(e){return e instanceof Dp&&this.bc===e.bc}}function gP(n,e,t,i){const o=n.A(1,e,t);Op("Data must be an object, but it was:",o,i);const l=[],h=nn.empty();Hi(i,((g,y)=>{const w=Z0(e,g,t);y=rt(y);const A=o.fc(w);if(y instanceof ch)l.push(w);else{const N=bl(y,A);N!=null&&(l.push(w),h.set(w,N))}}));const f=new yn(l);return new G0(h,f,o.fieldTransforms)}function yP(n,e,t,i,o,l){const h=n.A(1,e,t),f=[Vs(e,i,t)],g=[o];if(l.length%2!=0)throw new ee(z.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let N=0;N<l.length;N+=2)f.push(Vs(e,l[N])),g.push(l[N+1]);const y=[],w=nn.empty();for(let N=f.length-1;N>=0;--N)if(!eE(y,f[N])){const B=f[N];let Q=g[N];Q=rt(Q);const Y=h.fc(B);if(Q instanceof ch)y.push(B);else{const q=bl(Q,Y);q!=null&&(y.push(B),w.set(B,q))}}const A=new yn(y);return new G0(w,A,h.fieldTransforms)}function _P(n,e,t,i=!1){return bl(t,n.A(i?4:3,e))}function bl(n,e){if(X0(n=rt(n)))return Op("Unsupported field value:",e,n),J0(n,e);if(n instanceof lh)return(function(i,o){if(!Q0(o.dataSource))throw o.yc(`${i._methodName}() can only be used with update() and set()`);if(!o.path)throw o.yc(`${i._methodName}() is not currently supported inside arrays`);const l=i._toFieldTransform(o);l&&o.fieldTransforms.push(l)})(n,e),null;if(n===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),n instanceof Array){if(e.settings.arrayElement&&e.dataSource!==4)throw e.yc("Nested arrays are not supported");return(function(i,o){const l=[];let h=0;for(const f of i){let g=bl(f,o.gc(h));g==null&&(g={nullValue:"NULL_VALUE"}),l.push(g),h++}return{arrayValue:{values:l}}})(n,e)}return(function(i,o){if((i=rt(i))===null)return{nullValue:"NULL_VALUE"};if(typeof i=="number")return a0(o.serializer,i);if(typeof i=="boolean")return{booleanValue:i};if(typeof i=="string")return{stringValue:i};if(i instanceof Date){const l=Ze.fromDate(i);return{timestampValue:Nc(o.serializer,l)}}if(i instanceof Ze){const l=new Ze(i.seconds,1e3*Math.floor(i.nanoseconds/1e3));return{timestampValue:Nc(o.serializer,l)}}if(i instanceof mr)return{geoPointValue:{latitude:i.latitude,longitude:i.longitude}};if(i instanceof Rn)return{bytesValue:y0(o.serializer,i._byteString)};if(i instanceof at){const l=o.databaseId,h=i.firestore._databaseId;if(!h.isEqual(l))throw o.yc(`Document reference is for database ${h.projectId}/${h.database} but should be for database ${l.projectId}/${l.database}`);return{referenceValue:fp(i.firestore._databaseId||o.databaseId,i._key.path)}}if(i instanceof Bn)return(function(h,f){const g=h instanceof Bn?h.toArray():h;return{mapValue:{fields:{[Hw]:{stringValue:Ww},[kc]:{arrayValue:{values:g.map((w=>{if(typeof w!="number")throw f.yc("VectorValues must only contain numeric values.");return up(f.serializer,w)}))}}}}}})(i,o);if(S0(i))return i._toProto(o.serializer);throw o.yc(`Unsupported field value: ${Kc(i)}`)})(n,e)}function J0(n,e){const t={};return Uw(n)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):Hi(n,((i,o)=>{const l=bl(o,e.dc(i));l!=null&&(t[i]=l)})),{mapValue:{fields:t}}}function X0(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof Ze||n instanceof mr||n instanceof Rn||n instanceof at||n instanceof lh||n instanceof Bn||S0(n))}function Op(n,e,t){if(!X0(t)||!Mw(t)){const i=Kc(t);throw i==="an object"?e.yc(n+" a custom object"):e.yc(n+" "+i)}}function Vs(n,e,t){if((e=rt(e))instanceof Np)return e._internalPath;if(typeof e=="string")return Z0(n,e);throw Lc("Field path arguments must be of type string or ",n,!1,void 0,t)}const vP=new RegExp("[~\\*/\\[\\]]");function Z0(n,e,t){if(e.search(vP)>=0)throw Lc(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,t);try{return new Np(...e.split("."))._internalPath}catch{throw Lc(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,t)}}function Lc(n,e,t,i,o){const l=i&&!i.isEmpty(),h=o!==void 0;let f=`Function ${e}() called with invalid data`;t&&(f+=" (via `toFirestore()`)"),f+=". ";let g="";return(l||h)&&(g+=" (found",l&&(g+=` in field ${i}`),h&&(g+=` in document ${o}`),g+=")"),new ee(z.INVALID_ARGUMENT,f+n+g)}function eE(n,e){return n.some((t=>t.isEqual(e)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
