 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Of="storage";function jv(n=Ks(),e){n=Z(n);const r=an(n,Of).getImmediate({identifier:e}),s=kl("storage");return s&&yv(r,...s),r}function yv(n,e,t,r={}){gv(n,e,t,r)}function Ev(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new _v(t,r,s,e,cn)}function Tv(){Be(new Le(Of,Ev,"PUBLIC").setMultipleInstances(!0)),ke(Al,Rl,""),ke(Al,Rl,"esm2020")}Tv();export{Uv as A,Av as a,jv as b,Bv as c,Mv as d,Zy as e,Lv as f,II as g,vv as h,Om as i,Dv as j,bv as k,Nv as l,Rv as m,Cv as n,Pv as o,lT as p,Sv as q,kv as r,Vv as s,fT as t,Ov as u,hT as v,Fv as w,dT as x,xv as y,qv as z};
