const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AdminDashboard-C1XWglo_.js","assets/CheckCircleIcon-CuEM3TKm.js","assets/MemberDashboard-BvBVboUp.js"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ey;function ET(){if(ey)return Ka;ey=1;var n=Lf(),e=Symbol.for("react.element"),t=Symbol.for("react.fragment"),i=Object.prototype.hasOwnProperty,o=n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function h(f,g,y){var w,A={},N=null,B=null;y!==void 0&&(N=""+y),g.key!==void 0&&(N=""+g.key),g.ref!==void 0&&(B=g.ref);for(w in g)i.call(g,w)&&!l.hasOwnProperty(w)&&(A[w]=g[w]);if(f&&f.defaultProps)for(w in g=f.defaultProps,g)A[w]===void 0&&(A[w]=g[w]);return{$$typeof:e,type:f,key:N,ref:B,props:A,_owner:o.current}}return Ka.Fragment=t,Ka.jsx=h,Ka.jsxs=h,Ka}var ty;function TT(){return ty||(ty=1,Fd.exports=ET()),Fd.exports}var k=TT(),Ke=Lf();const rv=nv(Ke);var Gu={},jd={exports:{}},en={},Bd={exports:{}},zd={};/**
 * @license React
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  <defs>
    ...
    <path id="topTextCircle" d="M 66, 256 A 190,190 0 1,1 446, 256" />
    <path id="bottomTextCircle" d="M 66, 256 A 190,190 0 1,0 446, 256" />
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qT=()=>$T().__FIREBASE_DEFAULTS__,HT=()=>{if(typeof process>"u"||typeof uy>"u")return;const n=uy.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},WT=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=n&&hv(n[1]);return e&&JSON.parse(e)},Uc=()=>{try{return UT()||qT()||HT()||WT()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},dv=n=>{var e,t;return(t=(e=Uc())==null?void 0:e.emulatorHosts)==null?void 0:t[n]},fv=n=>{const e=dv(n);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const i=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),i]:[e.substring(0,t),i]},pv=()=>{var n;return(n=Uc())==null?void 0:n.config},mv=n=>{var e;return(e=Uc())==null?void 0:e[`_${n}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fs=tS;function Ev(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const i={name:df,automaticDataCollectionEnabled:!0,...e},o=i.name;if(typeof o!="string"||!o)throw Oi.create("bad-app-name",{appName:String(o)});if(t||(t=pv()),!t)throw Oi.create("no-options");const l=yc.get(o);if(l){if(ks(t,l.options)&&ks(i,l.config))return l;throw Oi.create("duplicate-app",{appName:o})}const h=new dI(o);for(const g of ff.values())h.addComponent(g);const f=new sS(t,i,h);return yc.set(o,f),f}function Bc(n=df){const e=yc.get(n);if(!e&&n===df&&pv())return Ev();if(!e)throw Oi.create("no-app",{appName:n});return e}function rn(n,e,t){let i=nS[n]??n;t&&(i+=`-${t}`);const o=i.match(/\s|\//),l=e.match(/\s|\//);if(o||l){const h=[`Unable to register library "${i}" with version "${e}":`];o&&h.push(`library name "${i}" contains illegal characters (whitespace or "/")`),o&&l&&h.push("and"),l&&h.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Hr.warn(h.join(" "));return}zn(new xn(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oS="firebase-heartbeat-database",aS=1,ul="firebase-heartbeat-store";let Gd=null;function Tv(){return Gd||(Gd=jc(oS,aS,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(ul)}catch(t){console.warn(t)}}}}).catch(n=>{throw Oi.create("idb-open",{originalErrorMessage:n.message})})),Gd}async function lS(n){try{const t=(await Tv()).transaction(ul),i=await t.objectStore(ul).get(Iv(n));return await t.done,i}catch(e){if(e instanceof Hn)Hr.warn(e.message);else{const t=Oi.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Hr.warn(t.message)}}}async function gy(n,e){try{const i=(await Tv()).transaction(ul,"readwrite");await i.objectStore(ul).put(e,Iv(n)),await i.done}catch(t){if(t instanceof Hn)Hr.warn(t.message);else{const i=Oi.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});Hr.warn(i.message)}}}function Iv(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */rn(gS,yS,"app");function Sv(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const _S=Sv,Av=new Ls("auth","Firebase",Sv());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $n(n,...e){throw Bf(n,...e)}function hr(n,...e){return Bf(n,...e)}function Rv(n,e,t){const i={..._S(),[e]:t};return new Ls("auth","Firebase",i).create(e,{appName:n.name})}function $r(n){return Rv(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Bf(n,...e){if(typeof n!="string"){const t=e[0],i=[...e.slice(1)];return i[0]&&(i[0].appName=n.name),n._errorFactory.create(t,...i)}return Av.create(n,...e)}function me(n,e,...t){if(!n)throw Bf(e,...t)}function jr(n){const e="INTERNAL ASSERTION FAILED: "+n;throw sc(e),new Error(e)}function Wr(n,e){n||jr(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wc(n){var A;const e=n.auth,t=await n.getIdToken(),i=await cl(n,vc(e,{idToken:t}));me(i==null?void 0:i.users.length,e,"internal-error");const o=i.users[0];n._notifyReloadListener(o);const l=(A=o.providerUserInfo)!=null&&A.length?Pv(o.providerUserInfo):[],h=VS(n.providerData,l),f=n.isAnonymous,g=!(n.email&&o.passwordHash)&&!(h!=null&&h.length),y=f?g:!1,w={uid:o.localId,displayName:o.displayName||null,photoURL:o.photoUrl||null,email:o.email||null,emailVerified:o.emailVerified||!1,phoneNumber:o.phoneNumber||null,tenantId:o.tenantId||null,providerData:h,metadata:new mf(o.createdAt,o.lastLoginAt),isAnonymous:y};Object.assign(n,w)}async function OS(n){const e=rt(n);await wc(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function VS(n,e){return[...n.filter(i=>!e.some(o=>o.providerId===i.providerId)),...e]}function Pv(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function LS(n,e){const t=await xv(n,{},async()=>{const i=Tl({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:o,apiKey:l}=n.config,h=await Cv(n,o,"/v1/token",`key=${l}`),f=await n._getAdditionalHeaders();f["Content-Type"]="application/x-www-form-urlencoded";const g={method:"POST",headers:f,body:i};return n.emulatorConfig&&Wo(n.emulatorConfig.host)&&(g.credentials="include"),kv.fetch()(h,g)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function MS(n,e){return qi(n,"POST","/v2/accounts:revokeToken",$i(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nv{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}Nv.type="NONE";const Iy=Nv;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sy(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Vv(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(bv(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Mv(e))return"Blackberry";if(Fv(e))return"Webos";if(Dv(e))return"Safari";if((e.includes("chrome/")||Ov(e))&&!e.includes("edge/"))return"Chrome";if(Lv(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=n.match(t);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function bv(n=Wt()){return/firefox\//i.test(n)}function Dv(n=Wt()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Ov(n=Wt()){return/crios\//i.test(n)}function Vv(n=Wt()){return/iemobile/i.test(n)}function Lv(n=Wt()){return/android/i.test(n)}function Mv(n=Wt()){return/blackberry/i.test(n)}function Fv(n=Wt()){return/webos/i.test(n)}function qf(n=Wt()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function FS(n=Wt()){var e;return qf(n)&&!!((e=window.navigator)!=null&&e.standalone)}function US(){return ZT()&&document.documentMode===10}function Uv(n=Wt()){return qf(n)||Lv(n)||Fv(n)||Mv(n)||/windows phone/i.test(n)||Vv(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jv(n,e=[]){let t;switch(n){case"Browser":t=Sy(Wt());break;case"Worker":t=`${Sy(Wt())}-${n}`;break;default:t=n}const i=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Fs}/${i}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Al extends qv{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wv(n,e,t=!1){if(gn(n.app))return Promise.reject($r(n));const i="signIn",o=await Hv(n,i,e),l=await Cs._fromIdTokenResponse(n,i,o);return t||await n._updateCurrentUser(l.user),l}async function pA(n,e){return Wv(Us(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kv(n){const e=Us(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function mA(n,e,t){if(gn(n.app))return Promise.reject($r(n));const i=Us(n),h=await gf(i,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",hA).catch(g=>{throw g.code==="auth/password-does-not-meet-requirements"&&Kv(n),g}),f=await Cs._fromIdTokenResponse(i,"signIn",h);return await i._updateCurrentUser(f.user),f}function gA(n,e,t){return gn(n.app)?Promise.reject($r(n)):pA(rt(n),Ko.credential(e,t)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&Kv(n),i})}function yA(n,e,t,i){return rt(n).onIdTokenChanged(e,t,i)}function _A(n,e,t){return rt(n).beforeAuthStateChanged(e,t)}function vA(n,e,t,i){return rt(n).onAuthStateChanged(e,t,i)}function ac(n){return rt(n).signOut()}const Tc="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gv{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(Tc,"1"),this.storage.removeItem(Tc),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Yv extends Gv{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}Yv.type="SESSION";const Jv=Yv;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xv(){return typeof dr().WorkerGlobalScope<"u"&&typeof dr().importScripts=="function"}async function RA(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function kA(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)==null?void 0:n.controller)||null}function xA(){return Xv()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class n0{constructor(e,t,i,o,l=!1){this.auth=e,this.resolver=i,this.user=o,this.bypassAuthState=l,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:i,postBody:o,tenantId:l,error:h,type:f}=e;if(h){this.reject(h);return}const g={auth:this.auth,requestUri:t,sessionId:i,tenantId:l||void 0,postBody:o||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(f)(g))}catch(y){this.reject(y)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return LA;case"linkViaPopup":case"linkViaRedirect":return FA;case"reauthViaPopup":case"reauthViaRedirect":return MA;default:$n(this.auth,"internal-error")}}resolve(e){Wr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){Wr(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const KA=600*1e3;class GA{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach(i=>{this.isEventForConsumer(e,i)&&(t=!0,this.sendToConsumer(e,i),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!QA(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){var i;if(e.error&&!r0(e)){const o=((i=e.error.code)==null?void 0:i.split("auth/")[1])||"internal-error";t.onError(hr(this.auth,o))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const i=t.eventId===null||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&i}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=KA&&this.cachedEventUids.clear(),this.cachedEventUids.has(Ny(e))}saveEventToCache(e){this.cachedEventUids.add(Ny(e)),this.lastProcessedEventTime=Date.now()}}function Ny(n){return[n.type,n.eventId,n.sessionId,n.tenantId].filter(e=>e).join("-")}function r0({type:n,error:e}){return n==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function QA(n){switch(n.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return r0(n);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const t1=new Il(3e4,6e4);function by(){const n=dr().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function n1(n){return new Promise((e,t)=>{var o,l,h;function i(){by(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{by(),t(hr(n,"network-request-failed"))},timeout:t1.get()})}if((l=(o=dr().gapi)==null?void 0:o.iframes)!=null&&l.Iframe)e(gapi.iframes.getContext());else if((h=dr().gapi)!=null&&h.load)i();else{const f=GS("iframefcb");return dr()[f]=()=>{gapi.load?i():t(hr(n,"network-request-failed"))},Bv(`${KS()}?onload=${f}`).catch(g=>t(g))}}).catch(e=>{throw uc=null,e})}let uc=null;function r1(n){return uc=uc||n1(n),uc}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i1=new Il(5e3,15e3),s1="__/auth/iframe",o1="emulator/auth/iframe",a1={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},l1=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function u1(n){const e=n.config;me(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?zf(e,o1):`https://${n.config.authDomain}/${s1}`,i={apiKey:e.apiKey,appName:n.name,v:Fs},o=l1.get(n.config.apiHost);o&&(i.eid=o);const l=n._getFrameworks();return l.length&&(i.fw=l.join(",")),`${t}?${Tl(i).slice(1)}`}async function c1(n){const e=await r1(n),t=dr().gapi;return me(t,n,"internal-error"),e.open({where:document.body,url:u1(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:a1,dontclear:!0},i=>new Promise(async(o,l)=>{await i.restyle({setHideOnLeave:!1});const h=hr(n,"network-request-failed"),f=dr().setTimeout(()=>{l(h)},i1.get());function g(){dr().clearTimeout(f),o(i)}i.ping(g).then(g,()=>{l(h)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const h1={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},d1=500,f1=600,p1="_blank",m1="http://localhost";class Dy{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function g1(n,e,t,i=d1,o=f1){const l=Math.max((window.screen.availHeight-o)/2,0).toString(),h=Math.max((window.screen.availWidth-i)/2,0).toString();let f="";const g={...h1,width:i.toString(),height:o.toString(),top:l,left:h},y=Wt().toLowerCase();t&&(f=Ov(y)?p1:t),bv(y)&&(e=e||m1,g.scrollbars="yes");const w=Object.entries(g).reduce((N,[B,Q])=>`${N}${B}=${Q},`,"");if(FS(y)&&f!=="_self")return y1(e||"",f),new Dy(null);const A=window.open(e||"",f,w);me(A,n,"popup-blocked");try{A.focus()}catch{}return new Dy(A)}function y1(n,e){const t=document.createElement("a");t.href=n,t.target=e;const i=document.createEvent("MouseEvent");i.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(i)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _1="__/auth/handler",v1="emulator/auth/handler",w1=encodeURIComponent("fac");async function Oy(n,e,t,i,o,l){me(n.config.authDomain,n,"auth-domain-config-required"),me(n.config.apiKey,n,"invalid-api-key");const h={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:i,v:Fs,eventId:o};if(e instanceof qv){e.setDefaultLanguage(n.languageCode),h.providerId=e.providerId||"",sI(e.getCustomParameters())||(h.customParameters=JSON.stringify(e.getCustomParameters()));for(const[w,A]of Object.entries({}))h[w]=A}if(e instanceof Al){const w=e.getScopes().filter(A=>A!=="");w.length>0&&(h.scopes=w.join(","))}n.tenantId&&(h.tid=n.tenantId);const f=h;for(const w of Object.keys(f))f[w]===void 0&&delete f[w];const g=await n._getAppCheckToken(),y=g?`#${w1}=${encodeURIComponent(g)}`:"";return`${E1(n)}?${Tl(f).slice(1)}${y}`}function E1({config:n}){return n.emulator?zf(n,v1):`https://${n.authDomain}/${_1}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yd="webStorageSupport";class T1{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Jv,this._completeRedirectFn=WA,this._overrideRedirectResult=$A}async _openPopup(e,t,i,o){var h;Wr((h=this.eventManagers[e._key()])==null?void 0:h.manager,"_initialize() not called before _openPopup()");const l=await Oy(e,t,i,pf(),o);return g1(e,l,Kf())}async _openRedirect(e,t,i,o){await this._originValidation(e);const l=await Oy(e,t,i,pf(),o);return AA(l),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:o,promise:l}=this.eventManagers[t];return o?Promise.resolve(o):(Wr(l,"If manager is not set, promise should be"),l)}const i=this.initAndGetManager(e);return this.eventManagers[t]={promise:i},i.catch(()=>{delete this.eventManagers[t]}),i}async initAndGetManager(e){const t=await c1(e),i=new GA(e);return t.register("authEvent",o=>(me(o==null?void 0:o.authEvent,e,"invalid-auth-event"),{status:i.onEvent(o.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:i},this.iframes[e._key()]=t,i}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Yd,{type:Yd},o=>{var h;const l=(h=o==null?void 0:o[0])==null?void 0:h[Yd];l!==void 0&&t(!!l),$n(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=ZA(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Uv()||Dv()||qf()}}const I1=T1;var Vy="@firebase/auth",Ly="1.12.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function A1(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function R1(n){zn(new xn("auth",(e,{options:t})=>{const i=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),l=e.getProvider("app-check-internal"),{apiKey:h,authDomain:f}=i.options;me(h&&!h.includes(":"),"invalid-api-key",{appName:i.name});const g={apiKey:h,authDomain:f,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:jv(n)},y=new qS(i,o,l,g);return eA(y,t),y},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,i)=>{e.getProvider("auth-internal").initialize()})),zn(new xn("auth-internal",e=>{const t=Us(e.getProvider("auth").getImmediate());return(i=>new S1(i))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),rn(Vy,Ly,A1(n)),rn(Vy,Ly,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const k1=300,x1=mv("authIdTokenMaxAge")||k1;let My=null;const C1=n=>async e=>{const t=e&&await e.getIdTokenResult(),i=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(i&&i>x1)return;const o=t==null?void 0:t.token;My!==o&&(My=o,await fetch(n,{method:o?"POST":"DELETE",headers:o?{Authorization:`Bearer ${o}`}:{}}))};function P1(n=Bc()){const e=Ms(n,"auth");if(e.isInitialized())return e.getImmediate();const t=ZS(n,{popupRedirectResolver:I1,persistence:[OA,TA,Jv]}),i=mv("authTokenSyncURL");if(i&&typeof isSecureContext=="boolean"&&isSecureContext){const l=new URL(i,location.origin);if(location.origin===l.origin){const h=C1(l.toString());_A(t,h,()=>h(t.currentUser)),yA(t,f=>h(f))}}const o=dv("auth");return o&&tA(t,`http://${o}`),t}function N1(){var n;return((n=document.getElementsByTagName("head"))==null?void 0:n[0])??document}HS({loadJS(n){return new Promise((e,t)=>{const i=document.createElement("script");i.setAttribute("src",n),i.onload=e,i.onerror=o=>{const l=hr("internal-error");l.customData=o,t(l)},i.type="text/javascript",i.charset="UTF-8",N1().appendChild(i)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});R1("Browser");const i0="@firebase/installations",Qf="0.6.21";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const s0=1e4,o0=`w:${Qf}`,a0="FIS_v2",b1="https://firebaseinstallations.googleapis.com/v1",D1=3600*1e3,O1="installations",V1="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function u0({projectId:n}){return`${b1}/projects/${n}/installations`}function c0(n){return{token:n.token,requestStatus:2,expiresIn:F1(n.expiresIn),creationTime:Date.now()}}async function h0(n,e){const i=(await e.json()).error;return Ps.create("request-failed",{requestName:n,serverCode:i.code,serverMessage:i.message,serverStatus:i.status})}function d0({apiKey:n}){return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":n})}function M1(n,{refreshToken:e}){const t=d0(n);return t.append("Authorization",U1(e)),t}async function f0(n){const e=await n();return e.status>=500&&e.status<600?n():e}function F1(n){return Number(n.replace("s","000"))}function U1(n){return`${a0} ${n}`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function j1({appConfig:n,heartbeatServiceProvider:e},{fid:t}){const i=u0(n),o=d0(n),l=e.getImmediate({optional:!0});if(l){const y=await l.getHeartbeatsHeader();y&&o.append("x-firebase-client",y)}const h={fid:t,authVersion:a0,appId:n.appId,sdkVersion:o0},f={method:"POST",headers:o,body:JSON.stringify(h)},g=await f0(()=>fetch(i,f));if(g.ok){const y=await g.json();return{fid:y.fid||t,registrationStatus:2,refreshToken:y.refreshToken,authToken:c0(y.authToken)}}else throw await h0("Create Installation",g)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function B1(n){return btoa(String.fromCharCode(...n)).replace(/\+/g,"-").replace(/\//g,"_")}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const z1=/^[cdef][\w-]{21}$/,_f="";function $1(){try{const n=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(n),n[0]=112+n[0]%16;const t=q1(n);return z1.test(t)?t:_f}catch{return _f}}function q1(n){return B1(n).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const m0=new Map;function g0(n,e){const t=Hc(n);y0(t,e),H1(t,e)}function y0(n,e){const t=m0.get(n);if(t)for(const i of t)i(e)}function H1(n,e){const t=W1();t&&t.postMessage({key:n,fid:e}),K1()}let Ts=null;function W1(){return!Ts&&"BroadcastChannel"in self&&(Ts=new BroadcastChannel("[Firebase] FID Change"),Ts.onmessage=n=>{y0(n.data.key,n.data.fid)}),Ts}function K1(){m0.size===0&&Ts&&(Ts.close(),Ts=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const G1="firebase-installations-database",Q1=1,Ns="firebase-installations-store";let Jd=null;function Yf(){return Jd||(Jd=jc(G1,Q1,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(Ns)}}})),Jd}async function Sc(n,e){const t=Hc(n),o=(await Yf()).transaction(Ns,"readwrite"),l=o.objectStore(Ns),h=await l.get(t);return await l.put(e,t),await o.done,(!h||h.fid!==e.fid)&&g0(n,e.fid),e}async function _0(n){const e=Hc(n),i=(await Yf()).transaction(Ns,"readwrite");await i.objectStore(Ns).delete(e),await i.done}async function Wc(n,e){const t=Hc(n),o=(await Yf()).transaction(Ns,"readwrite"),l=o.objectStore(Ns),h=await l.get(t),f=e(h);return f===void 0?await l.delete(t):await l.put(f,t),await o.done,f&&(!h||h.fid!==f.fid)&&g0(n,f.fid),f}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Jf(n){let e;const t=await Wc(n.appConfig,i=>{const o=Y1(i),l=J1(n,o);return e=l.registrationPromise,l.installationEntry});return t.fid===_f?{installationEntry:await e}:{installationEntry:t,registrationPromise:e}}function Y1(n){const e=n||{fid:$1(),registrationStatus:0};return v0(e)}function J1(n,e){if(e.registrationStatus===0){if(!navigator.onLine){const o=Promise.reject(Ps.create("app-offline"));return{installationEntry:e,registrationPromise:o}}const t={fid:e.fid,registrationStatus:1,registrationTime:Date.now()},i=X1(n,t);return{installationEntry:t,registrationPromise:i}}else return e.registrationStatus===1?{installationEntry:e,registrationPromise:Z1(n)}:{installationEntry:e}}async function X1(n,e){try{const t=await j1(n,e);return Sc(n.appConfig,t)}catch(t){throw l0(t)&&t.customData.serverCode===409?await _0(n.appConfig):await Sc(n.appConfig,{fid:e.fid,registrationStatus:0}),t}}async function Z1(n){let e=await Fy(n.appConfig);for(;e.registrationStatus===1;)await p0(100),e=await Fy(n.appConfig);if(e.registrationStatus===0){const{installationEntry:t,registrationPromise:i}=await Jf(n);return i||t}return e}function Fy(n){return Wc(n,e=>{if(!e)throw Ps.create("installation-not-found");return v0(e)})}function v0(n){return eR(n)?{fid:n.fid,registrationStatus:0}:n}function eR(n){return n.registrationStatus===1&&n.registrationTime+s0<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tR({appConfig:n,heartbeatServiceProvider:e},t){const i=nR(n,t),o=M1(n,t),l=e.getImmediate({optional:!0});if(l){const y=await l.getHeartbeatsHeader();y&&o.append("x-firebase-client",y)}const h={installation:{sdkVersion:o0,appId:n.appId}},f={method:"POST",headers:o,body:JSON.stringify(h)},g=await f0(()=>fetch(i,f));if(g.ok){const y=await g.json();return c0(y)}else throw await h0("Generate Auth Token",g)}function nR(n,{fid:e}){return`${u0(n)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xf(n,e=!1){let t;const i=await Wc(n.appConfig,l=>{if(!w0(l))throw Ps.create("not-registered");const h=l.authToken;if(!e&&sR(h))return l;if(h.requestStatus===1)return t=rR(n,e),l;{if(!navigator.onLine)throw Ps.create("app-offline");const f=aR(l);return t=iR(n,f),f}});return t?await t:i.authToken}async function rR(n,e){let t=await Uy(n.appConfig);for(;t.authToken.requestStatus===1;)await p0(100),t=await Uy(n.appConfig);const i=t.authToken;return i.requestStatus===0?Xf(n,e):i}function Uy(n){return Wc(n,e=>{if(!w0(e))throw Ps.create("not-registered");const t=e.authToken;return lR(t)?{...e,authToken:{requestStatus:0}}:e})}async function iR(n,e){try{const t=await tR(n,e),i={...e,authToken:t};return await Sc(n.appConfig,i),t}catch(t){if(l0(t)&&(t.customData.serverCode===401||t.customData.serverCode===404))await _0(n.appConfig);else{const i={...e,authToken:{requestStatus:0}};await Sc(n.appConfig,i)}throw t}}function w0(n){return n!==void 0&&n.registrationStatus===2}function sR(n){return n.requestStatus===2&&!oR(n)}function oR(n){const e=Date.now();return e<n.creationTime||n.creationTime+n.expiresIn<e+D1}function aR(n){const e={requestStatus:1,requestTime:Date.now()};return{...n,authToken:e}}function lR(n){return n.requestStatus===1&&n.requestTime+s0<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function uR(n){const e=n,{installationEntry:t,registrationPromise:i}=await Jf(e);return i?i.catch(console.error):Xf(e).catch(console.error),t.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cR(n,e=!1){const t=n;return await hR(t),(await Xf(t,e)).token}async function hR(n){const{registrationPromise:e}=await Jf(n);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dR(n){if(!n||!n.options)throw Xd("App Configuration");if(!n.name)throw Xd("App Name");const e=["projectId","apiKey","appId"];for(const t of e)if(!n.options[t])throw Xd(t);return{appName:n.name,projectId:n.options.projectId,apiKey:n.options.apiKey,appId:n.options.appId}}function Xd(n){return Ps.create("missing-app-config-values",{valueName:n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E0="installations",fR="installations-internal",pR=n=>{const e=n.getProvider("app").getImmediate(),t=dR(e),i=Ms(e,"heartbeat");return{app:e,appConfig:t,heartbeatServiceProvider:i,_delete:()=>Promise.resolve()}},mR=n=>{const e=n.getProvider("app").getImmediate(),t=Ms(e,E0).getImmediate();return{getId:()=>uR(t),getToken:o=>cR(t,o)}};function gR(){zn(new xn(E0,pR,"PUBLIC")),zn(new xn(fR,mR,"PRIVATE"))}gR();rn(i0,Qf);rn(i0,Qf,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yR="/firebase-messaging-sw.js",_R="/firebase-cloud-messaging-push-scope",T0="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",vR="https://fcmregistrations.googleapis.com/v1",I0="google.c.a.c_id",wR="google.c.a.c_l",ER="google.c.a.ts",TR="google.c.a.e",jy=1e4;var By;(function(n){n[n.DATA_MESSAGE=1]="DATA_MESSAGE",n[n.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(By||(By={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mr(n){const e=new Uint8Array(n);return btoa(String.fromCharCode(...e)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function IR(n){const e="=".repeat((4-n.length%4)%4),t=(n+e).replace(/\-/g,"+").replace(/_/g,"/"),i=atob(t),o=new Uint8Array(i.length);for(let l=0;l<i.length;++l)o[l]=i.charCodeAt(l);return o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kR="firebase-messaging-database",xR=1,fl="firebase-messaging-store";let ef=null;function S0(){return ef||(ef=jc(kR,xR,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(fl)}}})),ef}async function CR(n){const e=A0(n),i=await(await S0()).transaction(fl).objectStore(fl).get(e);if(i)return i;{const o=await AR(n.appConfig.senderId);if(o)return await Zf(n,o),o}}async function Zf(n,e){const t=A0(n),o=(await S0()).transaction(fl,"readwrite");return await o.objectStore(fl).put(e,t),await o.done,e}function A0({appConfig:n}){return n.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function NR(n,e){const t=await tp(n),i=R0(e),o={method:"POST",headers:t,body:JSON.stringify(i)};let l;try{l=await(await fetch(ep(n.appConfig),o)).json()}catch(h){throw Ht.create("token-subscribe-failed",{errorInfo:h==null?void 0:h.toString()})}if(l.error){const h=l.error.message;throw Ht.create("token-subscribe-failed",{errorInfo:h})}if(!l.token)throw Ht.create("token-subscribe-no-token");return l.token}async function bR(n,e){const t=await tp(n),i=R0(e.subscriptionOptions),o={method:"PATCH",headers:t,body:JSON.stringify(i)};let l;try{l=await(await fetch(`${ep(n.appConfig)}/${e.token}`,o)).json()}catch(h){throw Ht.create("token-update-failed",{errorInfo:h==null?void 0:h.toString()})}if(l.error){const h=l.error.message;throw Ht.create("token-update-failed",{errorInfo:h})}if(!l.token)throw Ht.create("token-update-no-token");return l.token}async function DR(n,e){const i={method:"DELETE",headers:await tp(n)};try{const l=await(await fetch(`${ep(n.appConfig)}/${e}`,i)).json();if(l.error){const h=l.error.message;throw Ht.create("token-unsubscribe-failed",{errorInfo:h})}}catch(o){throw Ht.create("token-unsubscribe-failed",{errorInfo:o==null?void 0:o.toString()})}}function ep({projectId:n}){return`${vR}/projects/${n}/registrations`}async function tp({appConfig:n,installations:e}){const t=await e.getToken();return new Headers({"Content-Type":"application/json",Accept:"application/json","x-goog-api-key":n.apiKey,"x-goog-firebase-installations-auth":`FIS ${t}`})}function R0({p256dh:n,auth:e,endpoint:t,vapidKey:i}){const o={web:{endpoint:t,auth:e,p256dh:n}};return i!==T0&&(o.web.applicationPubKey=i),o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const OR=10080*60*1e3;async function VR(n){const e=await MR(n.swRegistration,n.vapidKey),t={vapidKey:n.vapidKey,swScope:n.swRegistration.scope,endpoint:e.endpoint,auth:Mr(e.getKey("auth")),p256dh:Mr(e.getKey("p256dh"))},i=await CR(n.firebaseDependencies);if(i){if(FR(i.subscriptionOptions,t))return Date.now()>=i.createTime+OR?LR(n,{token:i.token,createTime:Date.now(),subscriptionOptions:t}):i.token;try{await DR(n.firebaseDependencies,i.token)}catch(o){console.warn(o)}return $y(n.firebaseDependencies,t)}else return $y(n.firebaseDependencies,t)}async function LR(n,e){try{const t=await bR(n.firebaseDependencies,e),i={...e,token:t,createTime:Date.now()};return await Zf(n.firebaseDependencies,i),t}catch(t){throw t}}async function $y(n,e){const i={token:await NR(n,e),createTime:Date.now(),subscriptionOptions:e};return await Zf(n,i),i.token}async function MR(n,e){const t=await n.pushManager.getSubscription();return t||n.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:IR(e)})}function FR(n,e){const t=e.vapidKey===n.vapidKey,i=e.endpoint===n.endpoint,o=e.auth===n.auth,l=e.p256dh===n.p256dh;return t&&i&&o&&l}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qy(n){const e={from:n.from,collapseKey:n.collapse_key,messageId:n.fcmMessageId};return UR(e,n),jR(e,n),BR(e,n),e}function UR(n,e){if(!e.notification)return;n.notification={};const t=e.notification.title;t&&(n.notification.title=t);const i=e.notification.body;i&&(n.notification.body=i);const o=e.notification.image;o&&(n.notification.image=o);const l=e.notification.icon;l&&(n.notification.icon=l)}function jR(n,e){e.data&&(n.data=e.data)}function BR(n,e){var o,l,h,f;if(!e.fcmOptions&&!((o=e.notification)!=null&&o.click_action))return;n.fcmOptions={};const t=((l=e.fcmOptions)==null?void 0:l.link)??((h=e.notification)==null?void 0:h.click_action);t&&(n.fcmOptions.link=t);const i=(f=e.fcmOptions)==null?void 0:f.analytics_label;i&&(n.fcmOptions.analyticsLabel=i)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zR(n){return typeof n=="object"&&!!n&&I0 in n}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $R(n){if(!n||!n.options)throw tf("App Configuration Object");if(!n.name)throw tf("App Name");const e=["projectId","apiKey","appId","messagingSenderId"],{options:t}=n;for(const i of e)if(!t[i])throw tf(i);return{appName:n.name,projectId:t.projectId,apiKey:t.apiKey,appId:t.appId,senderId:t.messagingSenderId}}function tf(n){return Ht.create("missing-app-config-values",{valueName:n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qR{constructor(e,t,i){this.deliveryMetricsExportedToBigQueryEnabled=!1,this.onBackgroundMessageHandler=null,this.onMessageHandler=null,this.logEvents=[],this.isLogServiceStarted=!1;const o=$R(e);this.firebaseDependencies={app:e,appConfig:o,installations:t,analyticsProvider:i}}_delete(){return Promise.resolve()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function KR(n,e){if(!e&&!n.swRegistration&&await HR(n),!(!e&&n.swRegistration)){if(!(e instanceof ServiceWorkerRegistration))throw Ht.create("invalid-sw-registration");n.swRegistration=e}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function GR(n,e){e?n.vapidKey=e:n.vapidKey||(n.vapidKey=T0)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function k0(n,e){if(!navigator)throw Ht.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw Ht.create("permission-blocked");return await GR(n,e==null?void 0:e.vapidKey),await KR(n,e==null?void 0:e.serviceWorkerRegistration),VR(n)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function QR(n,e,t){const i=YR(e);(await n.firebaseDependencies.analyticsProvider.get()).logEvent(i,{message_id:t[I0],message_name:t[wR],message_time:t[ER],message_device_time:Math.floor(Date.now()/1e3)})}function YR(n){switch(n){case dl.NOTIFICATION_CLICKED:return"notification_open";case dl.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function JR(n,e){const t=e.data;if(!t.isFirebaseMessaging)return;n.onMessageHandler&&t.messageType===dl.PUSH_RECEIVED&&(typeof n.onMessageHandler=="function"?n.onMessageHandler(qy(t)):n.onMessageHandler.next(qy(t)));const i=t.data;zR(i)&&i[TR]==="1"&&await QR(n,t.messageType,i)}const Hy="@firebase/messaging",Wy="0.12.25";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const XR=n=>{const e=new qR(n.getProvider("app").getImmediate(),n.getProvider("installations-internal").getImmediate(),n.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",t=>JR(e,t)),e},ZR=n=>{const e=n.getProvider("messaging").getImmediate();return{getToken:i=>k0(e,i)}};function ek(){zn(new xn("messaging",XR,"PUBLIC")),zn(new xn("messaging-internal",ZR,"PRIVATE")),rn(Hy,Wy),rn(Hy,Wy,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function tk(){try{await _v()}catch{return!1}return typeof window<"u"&&yv()&&tI()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ge(n,e,t){let i="Unexpected state";typeof e=="string"?i=e:t=e,O0(n,i,t)}function O0(n,e,t){let i=`FIRESTORE (${Go}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{i+=" CONTEXT: "+JSON.stringify(t)}catch{i+=" CONTEXT: "+t}throw Kr(i),new Error(i)}function qe(n,e,t,i){let o="Unexpected state";typeof t=="string"?o=t:i=t,n||O0(e,o,i)}function Ie(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const F0="";function Ak(n){let e="";for(let t=0;t<n.length;t++)e.length>0&&(e=e_(e)),e=Rk(n.get(t),e);return e_(e)}function Rk(n,e){let t=e;const i=n.length;for(let o=0;o<i;o++){const l=n.charAt(o);switch(l){case"\0":t+="";break;case F0:t+="";break;default:t+=l}}return t}function e_(n){return n+F0+""}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function t_(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function Hi(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function U0(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const B0="server_timestamp",z0="__type__",$0="__previous_value__",q0="__local_write_time__";function sp(n){var t,i;return((i=(((t=n==null?void 0:n.mapValue)==null?void 0:t.fields)||{})[z0])==null?void 0:i.stringValue)===B0}function Yc(n){const e=n.mapValue.fields[$0];return sp(e)?Yc(e):e}function ml(n){const e=Fi(n.mapValue.fields[q0].timestampValue);return new Ze(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xk{constructor(e,t,i,o,l,h,f,g,y,w,A){this.databaseId=e,this.appId=t,this.persistenceKey=i,this.host=o,this.ssl=l,this.forceLongPolling=h,this.autoDetectLongPolling=f,this.longPollingOptions=g,this.useFetchStreams=y,this.isUsingEmulator=w,this.apiKey=A}}const Rc="(default)";class gl{constructor(e,t){this.projectId=e,this.database=t||Rc}static empty(){return new gl("","")}get isDefaultDatabase(){return this.database===Rc}isEqual(e){return e instanceof gl&&e.projectId===this.projectId&&e.database===this.database}}function Ck(n,e){if(!Object.prototype.hasOwnProperty.apply(n.options,["projectId"]))throw new ee(z.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new gl(n.options.projectId,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class G0{}class _t extends G0{constructor(e,t,i){super(),this.field=e,this.op=t,this.value=i}static create(e,t,i){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,i):new Vk(e,t,i):t==="array-contains"?new Fk(e,i):t==="in"?new Uk(e,i):t==="not-in"?new jk(e,i):t==="array-contains-any"?new Bk(e,i):new _t(e,t,i)}static createKeyFieldInFilter(e,t,i){return t==="in"?new Lk(e,i):new Mk(e,i)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&t.nullValue===void 0&&this.matchesComparison(zo(t,this.value)):t!==null&&ji(this.value)===ji(t)&&this.matchesComparison(zo(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return ge(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class qn extends G0{constructor(e,t){super(),this.filters=e,this.op=t,this.Pe=null}static create(e,t){return new qn(e,t)}matches(e){return Q0(this)?this.filters.find((t=>!t.matches(e)))===void 0:this.filters.find((t=>t.matches(e)))!==void 0}getFlattenedFilters(){return this.Pe!==null||(this.Pe=this.filters.reduce(((e,t)=>e.concat(t.getFlattenedFilters())),[])),this.Pe}getFilters(){return Object.assign([],this.filters)}}function Q0(n){return n.op==="and"}function Y0(n){return Ok(n)&&Q0(n)}function Ok(n){for(const e of n.filters)if(e instanceof qn)return!1;return!0}function If(n){if(n instanceof _t)return n.field.canonicalString()+n.op.toString()+$o(n.value);if(Y0(n))return n.filters.map((e=>If(e))).join(",");{const e=n.filters.map((t=>If(t))).join(",");return`${n.op}(${e})`}}function J0(n,e){return n instanceof _t?(function(i,o){return o instanceof _t&&i.op===o.op&&i.field.isEqual(o.field)&&gr(i.value,o.value)})(n,e):n instanceof qn?(function(i,o){return o instanceof qn&&i.op===o.op&&i.filters.length===o.filters.length?i.filters.reduce(((l,h,f)=>l&&J0(h,o.filters[f])),!0):!1})(n,e):void ge(19439)}function X0(n){return n instanceof _t?(function(t){return`${t.field.canonicalString()} ${t.op} ${$o(t.value)}`})(n):n instanceof qn?(function(t){return t.op.toString()+" {"+t.getFilters().map(X0).join(" ,")+"}"})(n):"Filter"}class Vk extends _t{constructor(e,t,i){super(e,t,i),this.key=ce.fromName(i.referenceValue)}matches(e){const t=ce.comparator(e.key,this.key);return this.matchesComparison(t)}}class Lk extends _t{constructor(e,t){super(e,"in",t),this.keys=Z0("in",t)}matches(e){return this.keys.some((t=>t.isEqual(e.key)))}}class Mk extends _t{constructor(e,t){super(e,"not-in",t),this.keys=Z0("not-in",t)}matches(e){return!this.keys.some((t=>t.isEqual(e.key)))}}function Z0(n,e){var t;return(((t=e.arrayValue)==null?void 0:t.values)||[]).map((i=>ce.fromName(i.referenceValue)))}class Fk extends _t{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return op(t)&&yl(t.arrayValue,this.value)}}class Uk extends _t{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&yl(this.value.arrayValue,t)}}class jk extends _t{constructor(e,t){super(e,"not-in",t)}matches(e){if(yl(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&t.nullValue===void 0&&!yl(this.value.arrayValue,t)}}class Bk extends _t{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!op(t)||!t.arrayValue.values)&&t.arrayValue.values.some((i=>yl(this.value.arrayValue,i)))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class js{constructor(e,t){this.mapKeyFn=e,this.equalsFn=t,this.inner={},this.innerSize=0}get(e){const t=this.mapKeyFn(e),i=this.inner[t];if(i!==void 0){for(const[o,l]of i)if(this.equalsFn(o,e))return l}}has(e){return this.get(e)!==void 0}set(e,t){const i=this.mapKeyFn(e),o=this.inner[i];if(o===void 0)return this.inner[i]=[[e,t]],void this.innerSize++;for(let l=0;l<o.length;l++)if(this.equalsFn(o[l][0],e))return void(o[l]=[e,t]);o.push([e,t]),this.innerSize++}delete(e){const t=this.mapKeyFn(e),i=this.inner[t];if(i===void 0)return!1;for(let o=0;o<i.length;o++)if(this.equalsFn(i[o][0],e))return i.length===1?delete this.inner[t]:i.splice(o,1),this.innerSize--,!0;return!1}forEach(e){Hi(this.inner,((t,i)=>{for(const[o,l]of i)e(o,l)}))}isEmpty(){return U0(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function up(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Ac(e)?"-0":e}}function ow(n){return{integerValue:""+n}}function aw(n,e){return Sk(e)?ow(e):up(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eh{constructor(){this._=void 0}}function ex(n,e,t){return n instanceof Pc?(function(o,l){const h={fields:{[z0]:{stringValue:B0},[q0]:{timestampValue:{seconds:o.seconds,nanos:o.nanoseconds}}}};return l&&sp(l)&&(l=Yc(l)),l&&(h.fields[$0]=l),{mapValue:h}})(t,e):n instanceof vl?uw(n,e):n instanceof wl?cw(n,e):(function(o,l){const h=lw(o,l),f=d_(h)+d_(o.Ae);return Tf(h)&&Tf(o.Ae)?ow(f):up(o.serializer,f)})(n,e)}function tx(n,e,t){return n instanceof vl?uw(n,e):n instanceof wl?cw(n,e):t}function lw(n,e){return n instanceof El?(function(i){return Tf(i)||(function(l){return!!l&&"doubleValue"in l})(i)})(e)?e:{integerValue:0}:null}class Pc extends eh{}class vl extends eh{constructor(e){super(),this.elements=e}}function uw(n,e){const t=hw(e);for(const i of n.elements)t.some((o=>gr(o,i)))||t.push(i);return{arrayValue:{values:t}}}class wl extends eh{constructor(e){super(),this.elements=e}}function cw(n,e){let t=hw(e);for(const i of n.elements)t=t.filter((o=>!gr(o,i)));return{arrayValue:{values:t}}}class El extends eh{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function d_(n){return dt(n.integerValue||n.doubleValue)}function hw(n){return op(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
Total Duration: ${y-w}ms`),$.resolve({didRun:!0,sequenceNumbersCollected:o,targetsRemoved:l,documentsRemoved:A}))))}}function jx(n,e){return new Ux(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sf="RestConnection",hC={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class dC{get qo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",i=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Ko=t+"://"+e.host,this.Uo=`projects/${i}/databases/${o}`,this.$o=this.databaseId.database===Rc?`project_id=${i}`:`project_id=${i}&database_id=${o}`}Wo(e,t,i,o,l){const h=Nf(),f=this.Qo(e,t.toUriEncodedString());ne(sf,`Sending RPC '${e}' ${h}:`,f,i);const g={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.$o};this.Go(g,o,l);const{host:y}=new URL(f),w=Wo(y);return this.zo(e,f,g,i,w).then((A=>(ne(sf,`Received RPC '${e}' ${h}: `,A),A)),(A=>{throw Ds(sf,`RPC '${e}' ${h} failed with error: `,A,"url: ",f,"request:",i),A}))}jo(e,t,i,o,l,h){return this.Wo(e,t,i,o,l)}Go(e,t,i){e["X-Goog-Api-Client"]=(function(){return"gl-js/ fire/"+Go})(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach(((o,l)=>e[l]=o)),i&&i.headers.forEach(((o,l)=>e[l]=o))}Qo(e,t){const i=hC[e];let o=`${this.Ko}/v1/${t}:${i}`;return this.databaseInfo.apiKey&&(o=`${o}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),o}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Os="RemoteStore";class EC{constructor(e,t,i,o,l){this.localStore=e,this.datastore=t,this.asyncQueue=i,this.remoteSyncer={},this.Ta=[],this.Ea=new Map,this.Ia=new Set,this.Ra=[],this.Aa=l,this.Aa.Mo((h=>{i.enqueueAndForget((async()=>{Bs(this)&&(ne(Os,"Restarting streams for network reachability change."),await(async function(g){const y=Ie(g);y.Ia.add(4),await Pl(y),y.Va.set("Unknown"),y.Ia.delete(4),await ih(y)})(this))}))})),this.Va=new wC(i,o)}}async function ih(n){if(Bs(n))for(const e of n.Ra)await e(!0)}async function Pl(n){for(const e of n.Ra)await e(!1)}function Nw(n,e){const t=Ie(n);t.Ea.has(e.targetId)||(t.Ea.set(e.targetId,e),Ep(t)?wp(t):Xo(t).O_()&&vp(t,e))}function _p(n,e){const t=Ie(n),i=Xo(t);t.Ea.delete(e),i.O_()&&bw(t,e),t.Ea.size===0&&(i.O_()?i.L_():Bs(t)&&t.Va.set("Unknown"))}function vp(n,e){if(n.da.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(we.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}Xo(n).Z_(e)}function bw(n,e){n.da.$e(e),Xo(n).X_(e)}function wp(n){n.da=new px({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),At:e=>n.Ea.get(e)||null,ht:()=>n.datastore.serializer.databaseId}),Xo(n).start(),n.Va.ua()}function Ep(n){return Bs(n)&&!Xo(n).x_()&&n.Ea.size>0}function Bs(n){return Ie(n).Ia.size===0}function Dw(n){n.da=void 0}async function TC(n){n.Va.set("Online")}async function IC(n){n.Ea.forEach(((e,t)=>{vp(n,e)}))}async function SC(n,e){Dw(n),Ep(n)?(n.Va.ha(e),wp(n)):n.Va.set("Unknown")}async function AC(n,e,t){if(n.Va.set("Online"),e instanceof gw&&e.state===2&&e.cause)try{await(async function(o,l){const h=l.cause;for(const f of l.targetIds)o.Ea.has(f)&&(await o.remoteSyncer.rejectListen(f,h),o.Ea.delete(f),o.da.removeTarget(f))})(n,e)}catch(i){ne(Os,"Failed to remove targets %s: %s ",e.targetIds.join(","),i),await Dc(n,i)}else if(e instanceof pc?n.da.Xe(e):e instanceof mw?n.da.st(e):n.da.tt(e),!t.isEqual(we.min()))try{const i=await xw(n.localStore);t.compareTo(i)>=0&&await(function(l,h){const f=l.da.Tt(h);return f.targetChanges.forEach(((g,y)=>{if(g.resumeToken.approximateByteSize()>0){const w=l.Ea.get(y);w&&l.Ea.set(y,w.withResumeToken(g.resumeToken,h))}})),f.targetMismatches.forEach(((g,y)=>{const w=l.Ea.get(g);if(!w)return;l.Ea.set(g,w.withResumeToken(Vt.EMPTY_BYTE_STRING,w.snapshotVersion)),bw(l,g);const A=new bi(w.target,g,y,w.sequenceNumber);vp(l,A)})),l.remoteSyncer.applyRemoteEvent(f)})(n,t)}catch(i){ne(Os,"Failed to raise snapshot:",i),await Dc(n,i)}}async function Dc(n,e,t){if(!Yo(e))throw e;n.Ia.add(1),await Pl(n),n.Va.set("Offline"),t||(t=()=>xw(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{ne(Os,"Retrying IndexedDB access"),await t(),n.Ia.delete(1),await ih(n)}))}function Ow(n,e){return e().catch((t=>Dc(n,t,e)))}async function sh(n){const e=Ie(n),t=Bi(e);let i=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:ip;for(;RC(e);)try{const o=await oC(e.localStore,i);if(o===null){e.Ta.length===0&&t.L_();break}i=o.batchId,kC(e,o)}catch(o){await Dc(e,o)}Vw(e)&&Lw(e)}function RC(n){return Bs(n)&&n.Ta.length<10}function kC(n,e){n.Ta.push(e);const t=Bi(n);t.O_()&&t.Y_&&t.ea(e.mutations)}function Vw(n){return Bs(n)&&!Bi(n).x_()&&n.Ta.length>0}function Lw(n){Bi(n).start()}async function xC(n){Bi(n).ra()}async function CC(n){const e=Bi(n);for(const t of n.Ta)e.ea(t.mutations)}async function PC(n,e,t){const i=n.Ta.shift(),o=hp.from(i,e,t);await Ow(n,(()=>n.remoteSyncer.applySuccessfulWrite(o))),await sh(n)}async function NC(n,e){e&&Bi(n).Y_&&await(async function(i,o){if((function(h){return hx(h)&&h!==z.ABORTED})(o.code)){const l=i.Ta.shift();Bi(i).B_(),await Ow(i,(()=>i.remoteSyncer.rejectFailedWrite(l.batchId,o))),await sh(i)}})(n,e),Vw(n)&&Lw(n)}async function C_(n,e){const t=Ie(n);t.asyncQueue.verifyOperationInProgress(),ne(Os,"RemoteStore received new credentials");const i=Bs(t);t.Ia.add(3),await Pl(t),i&&t.Va.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ia.delete(3),await ih(t)}async function bC(n,e){const t=Ie(n);e?(t.Ia.delete(2),await ih(t)):e||(t.Ia.add(2),await Pl(t),t.Va.set("Unknown"))}function Xo(n){return n.ma||(n.ma=(function(t,i,o){const l=Ie(t);return l.sa(),new mC(i,l.connection,l.authCredentials,l.appCheckCredentials,l.serializer,o)})(n.datastore,n.asyncQueue,{Zo:TC.bind(null,n),Yo:IC.bind(null,n),t_:SC.bind(null,n),H_:AC.bind(null,n)}),n.Ra.push((async e=>{e?(n.ma.B_(),Ep(n)?wp(n):n.Va.set("Unknown")):(await n.ma.stop(),Dw(n))}))),n.ma}function Bi(n){return n.fa||(n.fa=(function(t,i,o){const l=Ie(t);return l.sa(),new gC(i,l.connection,l.authCredentials,l.appCheckCredentials,l.serializer,o)})(n.datastore,n.asyncQueue,{Zo:()=>Promise.resolve(),Yo:xC.bind(null,n),t_:NC.bind(null,n),ta:CC.bind(null,n),na:PC.bind(null,n)}),n.Ra.push((async e=>{e?(n.fa.B_(),await sh(n)):(await n.fa.stop(),n.Ta.length>0&&(ne(Os,`Stopping write stream with ${n.Ta.length} pending writes`),n.Ta=[]))}))),n.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lP="ComponentProvider",L_=new Map;function uP(n,e,t,i,o){return new xk(n,e,t,o.host,o.ssl,o.experimentalForceLongPolling,o.experimentalAutoDetectLongPolling,Ww(o.experimentalLongPollingOptions),o.useFetchStreams,o.isUsingEmulator,i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fP=/^__.*__$/;class pP{constructor(e,t,i){this.data=e,this.fieldMask=t,this.fieldTransforms=i}toMutation(e,t){return this.fieldMask!==null?new Wi(e,this.data,this.fieldMask,t,this.fieldTransforms):new xl(e,this.data,t,this.fieldTransforms)}}class Gw{constructor(e,t,i){this.data=e,this.fieldMask=t,this.fieldTransforms=i}toMutation(e,t){return new Wi(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function Qw(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw ge(40011,{dataSource:n})}}class bp{constructor(e,t,i,o,l,h){this.settings=e,this.databaseId=t,this.serializer=i,this.ignoreUndefinedProperties=o,l===void 0&&this.Ac(),this.fieldTransforms=l||[],this.fieldMask=h||[]}get path(){return this.settings.path}get dataSource(){return this.settings.dataSource}i(e){return new bp({...this.settings,...e},this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}dc(e){var o;const t=(o=this.path)==null?void 0:o.child(e),i=this.i({path:t,arrayElement:!1});return i.mc(e),i}fc(e){var o;const t=(o=this.path)==null?void 0:o.child(e),i=this.i({path:t,arrayElement:!1});return i.Ac(),i}gc(e){return this.i({path:void 0,arrayElement:!0})}yc(e){return Lc(e,this.settings.methodName,this.settings.hasConverter||!1,this.path,this.settings.targetDoc)}contains(e){return this.fieldMask.find((t=>e.isPrefixOf(t)))!==void 0||this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))!==void 0}Ac(){if(this.path)for(let e=0;e<this.path.length;e++)this.mc(this.path.get(e))}mc(e){if(e.length===0)throw this.yc("Document fields must not be empty");if(Qw(this.dataSource)&&fP.test(e))throw this.yc('Document fields cannot begin and end with "__"')}}class mP{constructor(e,t,i){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=i||rh(e)}A(e,t,i,o=!1){return new bp({dataSource:e,methodName:t,targetDoc:i,path:Ot.emptyPath(),arrayElement:!1,hasConverter:o},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function uh(n){const e=n._freezeSettings(),t=rh(n._databaseId);return new mP(n._databaseId,!!e.ignoreUndefinedProperties,t)}function Yw(n,e,t,i,o,l={}){const h=n.A(l.merge||l.mergeFields?2:0,e,t,o);Op("Data must be an object, but it was:",h,i);const f=Jw(i,h);let g,y;if(l.merge)g=new yn(h.fieldMask),y=h.fieldTransforms;else if(l.mergeFields){const w=[];for(const A of l.mergeFields){const N=Vs(e,A,t);if(!h.contains(N))throw new ee(z.INVALID_ARGUMENT,`Field '${N}' is specified in your field mask but missing from your input data.`);eE(w,N)||w.push(N)}g=new yn(w),y=h.fieldTransforms.filter((A=>g.covers(A.field)))}else g=null,y=h.fieldTransforms;return new pP(new nn(f),g,y)}class ch extends lh{_toFieldTransform(e){if(e.dataSource!==2)throw e.dataSource===1?e.yc(`${this._methodName}() can only appear at the top level of your update data`):e.yc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof ch}}class Dp extends lh{constructor(e,t){super(e),this.bc=t}_toFieldTransform(e){const t=new El(e.serializer,aw(e.serializer,this.bc));return new nx(e.path,t)}isEqual(e){return e instanceof Dp&&this.bc===e.bc}}function gP(n,e,t,i){const o=n.A(1,e,t);Op("Data must be an object, but it was:",o,i);const l=[],h=nn.empty();Hi(i,((g,y)=>{const w=Zw(e,g,t);y=rt(y);const A=o.fc(w);if(y instanceof ch)l.push(w);else{const N=bl(y,A);N!=null&&(l.push(w),h.set(w,N))}}));const f=new yn(l);return new Gw(h,f,o.fieldTransforms)}function yP(n,e,t,i,o,l){const h=n.A(1,e,t),f=[Vs(e,i,t)],g=[o];if(l.length%2!=0)throw new ee(z.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let N=0;N<l.length;N+=2)f.push(Vs(e,l[N])),g.push(l[N+1]);const y=[],w=nn.empty();for(let N=f.length-1;N>=0;--N)if(!eE(y,f[N])){const B=f[N];let Q=g[N];Q=rt(Q);const Y=h.fc(B);if(Q instanceof ch)y.push(B);else{const q=bl(Q,Y);q!=null&&(y.push(B),w.set(B,q))}}const A=new yn(y);return new Gw(w,A,h.fieldTransforms)}function _P(n,e,t,i=!1){return bl(t,n.A(i?4:3,e))}function bl(n,e){if(Xw(n=rt(n)))return Op("Unsupported field value:",e,n),Jw(n,e);if(n instanceof lh)return(function(i,o){if(!Qw(o.dataSource))throw o.yc(`${i._methodName}() can only be used with update() and set()`);if(!o.path)throw o.yc(`${i._methodName}() is not currently supported inside arrays`);const l=i._toFieldTransform(o);l&&o.fieldTransforms.push(l)})(n,e),null;if(n===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),n instanceof Array){if(e.settings.arrayElement&&e.dataSource!==4)throw e.yc("Nested arrays are not supported");return(function(i,o){const l=[];let h=0;for(const f of i){let g=bl(f,o.gc(h));g==null&&(g={nullValue:"NULL_VALUE"}),l.push(g),h++}return{arrayValue:{values:l}}})(n,e)}return(function(i,o){if((i=rt(i))===null)return{nullValue:"NULL_VALUE"};if(typeof i=="number")return aw(o.serializer,i);if(typeof i=="boolean")return{booleanValue:i};if(typeof i=="string")return{stringValue:i};if(i instanceof Date){const l=Ze.fromDate(i);return{timestampValue:Nc(o.serializer,l)}}if(i instanceof Ze){const l=new Ze(i.seconds,1e3*Math.floor(i.nanoseconds/1e3));return{timestampValue:Nc(o.serializer,l)}}if(i instanceof mr)return{geoPointValue:{latitude:i.latitude,longitude:i.longitude}};if(i instanceof Rn)return{bytesValue:yw(o.serializer,i._byteString)};if(i instanceof at){const l=o.databaseId,h=i.firestore._databaseId;if(!h.isEqual(l))throw o.yc(`Document reference is for database ${h.projectId}/${h.database} but should be for database ${l.projectId}/${l.database}`);return{referenceValue:fp(i.firestore._databaseId||o.databaseId,i._key.path)}}if(i instanceof Bn)return(function(h,f){const g=h instanceof Bn?h.toArray():h;return{mapValue:{fields:{[H0]:{stringValue:W0},[kc]:{arrayValue:{values:g.map((w=>{if(typeof w!="number")throw f.yc("VectorValues must only contain numeric values.");return up(f.serializer,w)}))}}}}}})(i,o);if(Sw(i))return i._toProto(o.serializer);throw o.yc(`Unsupported field value: ${Kc(i)}`)})(n,e)}function Jw(n,e){const t={};return U0(n)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):Hi(n,((i,o)=>{const l=bl(o,e.dc(i));l!=null&&(t[i]=l)})),{mapValue:{fields:t}}}function Xw(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof Ze||n instanceof mr||n instanceof Rn||n instanceof at||n instanceof lh||n instanceof Bn||Sw(n))}function Op(n,e,t){if(!Xw(t)||!M0(t)){const i=Kc(t);throw i==="an object"?e.yc(n+" a custom object"):e.yc(n+" "+i)}}function Vs(n,e,t){if((e=rt(e))instanceof Np)return e._internalPath;if(typeof e=="string")return Zw(n,e);throw Lc("Field path arguments must be of type string or ",n,!1,void 0,t)}const vP=new RegExp("[~\\*/\\[\\]]");function Zw(n,e,t){if(e.search(vP)>=0)throw Lc(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,t);try{return new Np(...e.split("."))._internalPath}catch{throw Lc(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,t)}}function Lc(n,e,t,i,o){const l=i&&!i.isEmpty(),h=o!==void 0;let f=`Function ${e}() called with invalid data`;t&&(f+=" (via `toFirestore()`)"),f+=". ";let g="";return(l||h)&&(g+=" (found",l&&(g+=` in field ${i}`),h&&(g+=` in document ${o}`),g+=")"),new ee(z.INVALID_ARGUMENT,f+n+g)}function eE(n,e){return n.some((t=>t.isEqual(e)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tE{constructor(e,t,i,o,l){this._firestore=e,this._userDataWriter=t,this._key=i,this._document=o,this._converter=l}get id(){return this._key.path.lastSegment()}get ref(){return new at(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){const e=new EP(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}_fieldsProto(){var e;return((e=this._document)==null?void 0:e.data.clone().value.mapValue.fields)??void 0}get(e){if(this._document){const t=this._document.data.field(Vs("DocumentSnapshot.get",e));if(t!==null)return this._userDataWriter.convertValue(t)}}}class EP extends tE{data(){return super.data()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oE(n){n=sn(n,at);const e=sn(n.firestore,Qr),t=ah(e);return sP(t,n._key).then((i=>aE(e,n,i)))}function Fr(n){n=sn(n,Yr);const e=sn(n.firestore,Qr),t=ah(e),i=new Vp(e);return nE(n._query),oP(t,n._query).then((o=>new Rs(e,i,n,o)))}function ll(n,e,t){n=sn(n,at);const i=sn(n.firestore,Qr),o=sE(n.converter,e,t),l=uh(i);return dh(i,[Yw(l,"setDoc",n._key,o,n.converter!==null,t).toMutation(n._key,kn.none())])}function Qa(n,e,t,...i){n=sn(n,at);const o=sn(n.firestore,Qr),l=uh(o);let h;return h=typeof(e=rt(e))=="string"||e instanceof Np?yP(l,"updateDoc",n._key,e,t,i):gP(l,"updateDoc",n._key,e),dh(o,[h.toMutation(n._key,kn.exists(!0))])}function tc(n){return dh(sn(n.firestore,Qr),[new cp(n._key,kn.none())])}function nc(n,e){const t=sn(n.firestore,Qr),i=kt(n),o=sE(n.converter,e),l=uh(n.firestore);return dh(t,[Yw(l,"addDoc",i._key,o,n.converter!==null,{}).toMutation(i._key,kn.exists(!1))]).then((()=>i))}function ws(n,...e){var y,w,A;n=rt(n);let t={includeMetadataChanges:!1,source:"default"},i=0;typeof e[i]!="object"||H_(e[i])||(t=e[i++]);const o={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(H_(e[i])){const N=e[i];e[i]=(y=N.next)==null?void 0:y.bind(N),e[i+1]=(w=N.error)==null?void 0:w.bind(N),e[i+2]=(A=N.complete)==null?void 0:A.bind(N)}let l,h,f;if(n instanceof at)h=sn(n.firestore,Qr),f=Jc(n._key.path),l={next:N=>{e[i]&&e[i](aE(h,n,N))},error:e[i+1],complete:e[i+2]};else{const N=sn(n,Yr);h=sn(N.firestore,Qr),f=N._query;const B=new Vp(h);l={next:Q=>{e[i]&&e[i](new Rs(h,B,N,Q))},error:e[i+1],complete:e[i+2]},nE(n._query)}const g=ah(h);return iP(g,f,o,l)}function dh(n,e){const t=ah(n);return aP(t,e)}function aE(n,e,t){const i=t.docs.get(e._key),o=new Vp(n);return new As(n,o,e._key,i,new tl(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){ok(Fs),zn(new xn("firestore",((i,{instanceIdentifier:o,options:l})=>{const h=i.getProvider("app").getImmediate(),f=new Qr(new uk(i.getProvider("auth-internal")),new dk(h,i.getProvider("app-check-internal")),Ck(h,o),h);return l={useFetchStreams:t,...l},f._setSettings(l),f}),"PUBLIC").setMultipleInstances(!0)),rn($_,q_,e),rn($_,q_,"esm2020")})();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lE="firebasestorage.googleapis.com",IP="storageBucket",SP=120*1e3,AP=600*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jn{constructor(e,t){this.bucket=e,this.path_=t}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,t){let i;try{i=jn.makeFromUrl(e,t)}catch{return new jn(e,"")}if(i.path==="")return i;throw PP(e)}static makeFromUrl(e,t){let i=null;const o="([A-Za-z0-9.\\-_]+)";function l(fe){fe.path.charAt(fe.path.length-1)==="/"&&(fe.path_=fe.path_.slice(0,-1))}const h="(/(.*))?$",f=new RegExp("^gs://"+o+h,"i"),g={bucket:1,path:3};function y(fe){fe.path_=decodeURIComponent(fe.path)}const w="v[A-Za-z0-9_]+",A=t.replace(/[.]/g,"\\."),N="(/([^?#]*).*)?$",B=new RegExp(`^https?://${A}/${w}/b/${o}/o${N}`,"i"),Q={bucket:1,path:3},Y=t===lE?"(?:storage.googleapis.com|storage.cloud.google.com)":t,q="([^?#]*)",pe=new RegExp(`^https?://${Y}/${o}/${q}`,"i"),Se=[{regex:f,indices:g,postModify:l},{regex:B,indices:Q,postModify:y},{regex:pe,indices:{bucket:1,path:2},postModify:y}];for(let fe=0;fe<Se.length;fe++){const xe=Se[fe],Re=xe.regex.exec(e);if(Re){const b=Re[xe.indices.bucket];let R=Re[xe.indices.path];R||(R=""),i=new jn(b,R),xe.postModify(i);break}}if(i==null)throw CP(e);return i}}class bP{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
