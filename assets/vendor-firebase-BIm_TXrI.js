 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gf="storage";function wv(n=Ls(),e){n=re(n);const r=sn(n,gf).getImmediate({identifier:e}),s=Il("storage");return s&&Jw(r,...s),r}function Jw(n,e,t,r={}){Qw(n,e,t,r)}function Xw(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new Yw(t,r,s,e,on)}function Zw(){Ue(new Me(gf,Xw,"PUBLIC").setMultipleInstances(!0)),Pe(ml,gl,""),Pe(ml,gl,"esm2020")}Zw();export{nv as a,wv as b,Tv as c,dv as d,Dy as e,fv as f,Ev as g,tv as h,gm as i,uv as j,rv as k,av as l,mv as m,yv as n,ov as o,gv as p,sv as q,cv as r,lv as s,_v as t,hv as u,pv as v,iv as w,Iv as x};
