const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/AdminDashboard-CdYO2krW.js","assets/CheckCircleIcon-B9iJ7_Q_.js","assets/MemberDashboard-B9ir8MM2.js"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Rn(HI,WI,"app");function ev(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const KI=ev,tv=new Ps("auth","Firebase",ev());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dc=new Rf("@firebase/auth");function GI(r,...e){dc.logLevel<=Se.WARN&&dc.warn(`Auth (${jo}): ${r}`,...e)}function Xu(r,...e){dc.logLevel<=Se.ERROR&&dc.error(`Auth (${jo}): ${r}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function FS(r){switch(r){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function US(r){const e=Ha(Wa(r)).link,t=e?Ha(Wa(e)).deep_link_id:null,s=Ha(Wa(r)).deep_link_id;return(s?Ha(Wa(s)).link:null)||s||t||e||r}class bf{constructor(e){const t=Ha(Wa(e)),s=t.apiKey??null,o=t.oobCode??null,l=FS(t.mode??null);de(s&&o&&l,"argument-error"),this.apiKey=s,this.operation=l,this.code=o,this.continueUrl=t.continueUrl??null,this.languageCode=t.lang??null,this.tenantId=t.tenantId??null}static parseLink(e){const t=US(e);try{return new bf(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bo{constructor(){this.providerId=Bo.PROVIDER_ID}static credential(e,t){return sl._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const s=bf.parseLink(t);return de(s,"argument-error"),sl._fromEmailAndCode(e,s.code,s.tenantId)}}Bo.PROVIDER_ID="password";Bo.EMAIL_PASSWORD_SIGN_IN_METHOD="password";Bo.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ri extends vl{constructor(){super("twitter.com")}static credential(e,t){return Es._fromParams({providerId:Ri.PROVIDER_ID,signInMethod:Ri.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return Ri.credentialFromTaggedObject(e)}static credentialFromError(e){return Ri.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:s}=e;if(!t||!s)return null;try{return Ri.credential(t,s)}catch{return null}}}Ri.TWITTER_SIGN_IN_METHOD="twitter.com";Ri.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zS(r,e,t=!1){const{auth:s}=r;if(Sn(s.app))return Promise.reject(Fr(s));const o="reauthenticate";try{const l=await il(r,Ev(s,o,e,r),t);de(l.idToken,s,"internal-error");const h=Nf(l.idToken);de(h,s,"internal-error");const{sub:m}=h;return de(r.uid===m,s,"user-mismatch"),Ts._forOperation(r,o,l)}catch(l){throw(l==null?void 0:l.code)==="auth/user-not-found"&&Bn(s,"user-mismatch"),l}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Iv(r){const e=xs(r);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function qS(r,e,t){if(Sn(r.app))return Promise.reject(Fr(r));const s=xs(r),h=await sf(s,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",jS).catch(g=>{throw g.code==="auth/password-does-not-meet-requirements"&&Iv(r),g}),m=await Ts._fromIdTokenResponse(s,"signIn",h);return await s._updateCurrentUser(m.user),m}function HS(r,e,t){return Sn(r.app)?Promise.reject(Fr(r)):$S(ct(r),Bo.credential(e,t)).catch(async s=>{throw s.code==="auth/password-does-not-meet-requirements"&&Iv(r),s})}function WS(r,e,t,s){return ct(r).onIdTokenChanged(e,t,s)}function KS(r,e,t){return ct(r).beforeAuthStateChanged(e,t)}function ec(r){return ct(r).signOut()}const gc="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const DA=new yl(5e3,15e3),VA="__/auth/iframe",bA="emulator/auth/iframe",OA={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},MA=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function LA(r){const e=r.config;de(e.authDomain,r,"auth-domain-config-required");const t=e.emulator?xf(e,bA):`https://${r.config.authDomain}/${VA}`,s={apiKey:e.apiKey,appName:r.name,v:jo},o=MA.get(r.config.apiHost);o&&(s.eid=o);const l=r._getFrameworks();return l.length&&(s.fw=l.join(",")),`${t}?${ml(s).slice(1)}`}async function FA(r){const e=await NA(r),t=ur().gapi;return de(t,r,"internal-error"),e.open({where:document.body,url:LA(r),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:OA,dontclear:!0},s=>new Promise(async(o,l)=>{await s.restyle({setHideOnLeave:!1});const h=lr(r,"network-request-failed"),m=ur().setTimeout(()=>{l(h)},DA.get());function g(){ur().clearTimeout(m),o(s)}s.ping(g).then(g,()=>{l(h)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ov=1e4,Mv=`w:${Lf}`,Lv="FIS_v2",oR="https://firebaseinstallations.googleapis.com/v1",aR=3600*1e3,lR="installations",uR="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function pR({appConfig:r,heartbeatServiceProvider:e},{fid:t}){const s=Uv(r),o=zv(r),l=e.getImmediate({optional:!0});if(l){const _=await l.getHeartbeatsHeader();_&&o.append("x-firebase-client",_)}const h={fid:t,authVersion:Lv,appId:r.appId,sdkVersion:Mv},m={method:"POST",headers:o,body:JSON.stringify(h)},g=await $v(()=>fetch(s,m));if(g.ok){const _=await g.json();return{fid:_.fid||t,registrationStatus:2,refreshToken:_.refreshToken,authToken:jv(_.authToken)}}else throw await Bv("Create Installation",g)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hv=new Map;function Wv(r,e){const t=Lc(r);Kv(t,e),vR(t,e)}function Kv(r,e){const t=Hv.get(r);if(t)for(const s of t)s(e)}function vR(r,e){const t=wR();t&&t.postMessage({key:r,fid:e}),ER()}let gs=null;function wR(){return!gs&&"BroadcastChannel"in self&&(gs=new BroadcastChannel("[Firebase] FID Change"),gs.onmessage=r=>{Kv(r.data.key,r.data.fid)}),gs}function ER(){Hv.size===0&&gs&&(gs.close(),gs=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const TR="firebase-installations-database",IR=1,Ss="firebase-installations-store";let Bd=null;function Ff(){return Bd||(Bd=Vc(TR,IR,{upgrade:(r,e)=>{switch(e){case 0:r.createObjectStore(Ss)}}})),Bd}async function _c(r,e){const t=Lc(r),o=(await Ff()).transaction(Ss,"readwrite"),l=o.objectStore(Ss),h=await l.get(t);return await l.put(e,t),await o.done,(!h||h.fid!==e.fid)&&Wv(r,e.fid),e}async function Gv(r){const e=Lc(r),s=(await Ff()).transaction(Ss,"readwrite");await s.objectStore(Ss).delete(e),await s.done}async function Fc(r,e){const t=Lc(r),o=(await Ff()).transaction(Ss,"readwrite"),l=o.objectStore(Ss),h=await l.get(t),m=e(h);return m===void 0?await l.delete(t):await l.put(m,t),await o.done,m&&(!h||h.fid!==m.fid)&&Wv(r,m.fid),m}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function PR({appConfig:r,heartbeatServiceProvider:e},t){const s=xR(r,t),o=hR(r,t),l=e.getImmediate({optional:!0});if(l){const _=await l.getHeartbeatsHeader();_&&o.append("x-firebase-client",_)}const h={installation:{sdkVersion:Mv,appId:r.appId}},m={method:"POST",headers:o,body:JSON.stringify(h)},g=await $v(()=>fetch(s,m));if(g.ok){const _=await g.json();return jv(_)}else throw await Bv("Generate Auth Token",g)}function xR(r,{fid:e}){return`${Uv(r)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function LR(r){const e=r,{installationEntry:t,registrationPromise:s}=await Uf(e);return s?s.catch(console.error):jf(e).catch(console.error),t.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jv="installations",BR="installations-internal",zR=r=>{const e=r.getProvider("app").getImmediate(),t=jR(e),s=Uo(e,"heartbeat");return{app:e,appConfig:t,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},$R=r=>{const e=r.getProvider("app").getImmediate(),t=Uo(e,Jv).getImmediate();return{getId:()=>LR(t),getToken:o=>FR(t,o)}};function qR(){fr(new jn(Jv,zR,"PUBLIC")),fr(new jn(BR,$R,"PRIVATE"))}qR();Rn(bv,Lf);Rn(bv,Lf,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tk="firebase-messaging-database",nk=1,al="firebase-messaging-store";let qd=null;function ew(){return qd||(qd=Vc(tk,nk,{upgrade:(r,e)=>{switch(e){case 0:r.createObjectStore(al)}}})),qd}async function rk(r){const e=tw(r),s=await(await ew()).transaction(al).objectStore(al).get(e);if(s)return s;{const o=await ZR(r.appConfig.senderId);if(o)return await Bf(r,o),o}}async function Bf(r,e){const t=tw(r),o=(await ew()).transaction(al,"readwrite");return await o.objectStore(al).put(e,t),await o.done,e}function tw({appConfig:r}){return r.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ik(r,e,t){const s=Sk(e);(await r.firebaseDependencies.analyticsProvider.get()).logEvent(s,{message_id:t[Zv],message_name:t[GR],message_time:t[QR],message_device_time:Math.floor(Date.now()/1e3)})}function Sk(r){switch(r){case ol.NOTIFICATION_CLICKED:return"notification_open";case ol.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ak(r,e){const t=e.data;if(!t.isFirebaseMessaging)return;r.onMessageHandler&&t.messageType===ol.PUSH_RECEIVED&&(typeof r.onMessageHandler=="function"?r.onMessageHandler(Dy(t)):r.onMessageHandler.next(Dy(t)));const s=t.data;gk(s)&&s[YR]==="1"&&await Ik(r,t.messageType,s)}const Vy="@firebase/messaging",by="0.12.25";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var xi,iw;(function(){var r;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(D,R){function T(){}T.prototype=R.prototype,D.F=R.prototype,D.prototype=new T,D.prototype.constructor=D,D.D=function(C,A,V){for(var I=Array(arguments.length-2),xe=2;xe<arguments.length;xe++)I[xe-2]=arguments[xe];return R.prototype[A].apply(C,I)}}function t(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(s,t),s.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(D,R,T){T||(T=0);const C=Array(16);if(typeof R=="string")for(var A=0;A<16;++A)C[A]=R.charCodeAt(T++)|R.charCodeAt(T++)<<8|R.charCodeAt(T++)<<16|R.charCodeAt(T++)<<24;else for(A=0;A<16;++A)C[A]=R[T++]|R[T++]<<8|R[T++]<<16|R[T++]<<24;R=D.g[0],T=D.g[1],A=D.g[2];let V=D.g[3],I;I=R+(V^T&(A^V))+C[0]+3614090360&4294967295,R=T+(I<<7&4294967295|I>>>25),I=V+(A^R&(T^A))+C[1]+3905402710&4294967295,V=R+(I<<12&4294967295|I>>>20),I=A+(T^V&(R^T))+C[2]+606105819&4294967295,A=V+(I<<17&4294967295|I>>>15),I=T+(R^A&(V^R))+C[3]+3250441966&4294967295,T=A+(I<<22&4294967295|I>>>10),I=R+(V^T&(A^V))+C[4]+4118548399&4294967295,R=T+(I<<7&4294967295|I>>>25),I=V+(A^R&(T^A))+C[5]+1200080426&4294967295,V=R+(I<<12&4294967295|I>>>20),I=A+(T^V&(R^T))+C[6]+2821735955&4294967295,A=V+(I<<17&4294967295|I>>>15),I=T+(R^A&(V^R))+C[7]+4249261313&4294967295,T=A+(I<<22&4294967295|I>>>10),I=R+(V^T&(A^V))+C[8]+1770035416&4294967295,R=T+(I<<7&4294967295|I>>>25),I=V+(A^R&(T^A))+C[9]+2336552879&4294967295,V=R+(I<<12&4294967295|I>>>20),I=A+(T^V&(R^T))+C[10]+4294925233&4294967295,A=V+(I<<17&4294967295|I>>>15),I=T+(R^A&(V^R))+C[11]+2304563134&4294967295,T=A+(I<<22&4294967295|I>>>10),I=R+(V^T&(A^V))+C[12]+1804603682&4294967295,R=T+(I<<7&4294967295|I>>>25),I=V+(A^R&(T^A))+C[13]+4254626195&4294967295,V=R+(I<<12&4294967295|I>>>20),I=A+(T^V&(R^T))+C[14]+2792965006&4294967295,A=V+(I<<17&4294967295|I>>>15),I=T+(R^A&(V^R))+C[15]+1236535329&4294967295,T=A+(I<<22&4294967295|I>>>10),I=R+(A^V&(T^A))+C[1]+4129170786&4294967295,R=T+(I<<5&4294967295|I>>>27),I=V+(T^A&(R^T))+C[6]+3225465664&4294967295,V=R+(I<<9&4294967295|I>>>23),I=A+(R^T&(V^R))+C[11]+643717713&4294967295,A=V+(I<<14&4294967295|I>>>18),I=T+(V^R&(A^V))+C[0]+3921069994&4294967295,T=A+(I<<20&4294967295|I>>>12),I=R+(A^V&(T^A))+C[5]+3593408605&4294967295,R=T+(I<<5&4294967295|I>>>27),I=V+(T^A&(R^T))+C[10]+38016083&4294967295,V=R+(I<<9&4294967295|I>>>23),I=A+(R^T&(V^R))+C[15]+3634488961&4294967295,A=V+(I<<14&4294967295|I>>>18),I=T+(V^R&(A^V))+C[4]+3889429448&4294967295,T=A+(I<<20&4294967295|I>>>12),I=R+(A^V&(T^A))+C[9]+568446438&4294967295,R=T+(I<<5&4294967295|I>>>27),I=V+(T^A&(R^T))+C[14]+3275163606&4294967295,V=R+(I<<9&4294967295|I>>>23),I=A+(R^T&(V^R))+C[3]+4107603335&4294967295,A=V+(I<<14&4294967295|I>>>18),I=T+(V^R&(A^V))+C[8]+1163531501&4294967295,T=A+(I<<20&4294967295|I>>>12),I=R+(A^V&(T^A))+C[13]+2850285829&4294967295,R=T+(I<<5&4294967295|I>>>27),I=V+(T^A&(R^T))+C[2]+4243563512&4294967295,V=R+(I<<9&4294967295|I>>>23),I=A+(R^T&(V^R))+C[7]+1735328473&4294967295,A=V+(I<<14&4294967295|I>>>18),I=T+(V^R&(A^V))+C[12]+2368359562&4294967295,T=A+(I<<20&4294967295|I>>>12),I=R+(T^A^V)+C[5]+4294588738&4294967295,R=T+(I<<4&4294967295|I>>>28),I=V+(R^T^A)+C[8]+2272392833&4294967295,V=R+(I<<11&4294967295|I>>>21),I=A+(V^R^T)+C[11]+1839030562&4294967295,A=V+(I<<16&4294967295|I>>>16),I=T+(A^V^R)+C[14]+4259657740&4294967295,T=A+(I<<23&4294967295|I>>>9),I=R+(T^A^V)+C[1]+2763975236&4294967295,R=T+(I<<4&4294967295|I>>>28),I=V+(R^T^A)+C[4]+1272893353&4294967295,V=R+(I<<11&4294967295|I>>>21),I=A+(V^R^T)+C[7]+4139469664&4294967295,A=V+(I<<16&4294967295|I>>>16),I=T+(A^V^R)+C[10]+3200236656&4294967295,T=A+(I<<23&4294967295|I>>>9),I=R+(T^A^V)+C[13]+681279174&4294967295,R=T+(I<<4&4294967295|I>>>28),I=V+(R^T^A)+C[0]+3936430074&4294967295,V=R+(I<<11&4294967295|I>>>21),I=A+(V^R^T)+C[3]+3572445317&4294967295,A=V+(I<<16&4294967295|I>>>16),I=T+(A^V^R)+C[6]+76029189&4294967295,T=A+(I<<23&4294967295|I>>>9),I=R+(T^A^V)+C[9]+3654602809&4294967295,R=T+(I<<4&4294967295|I>>>28),I=V+(R^T^A)+C[12]+3873151461&4294967295,V=R+(I<<11&4294967295|I>>>21),I=A+(V^R^T)+C[15]+530742520&4294967295,A=V+(I<<16&4294967295|I>>>16),I=T+(A^V^R)+C[2]+3299628645&4294967295,T=A+(I<<23&4294967295|I>>>9),I=R+(A^(T|~V))+C[0]+4096336452&4294967295,R=T+(I<<6&4294967295|I>>>26),I=V+(T^(R|~A))+C[7]+1126891415&4294967295,V=R+(I<<10&4294967295|I>>>22),I=A+(R^(V|~T))+C[14]+2878612391&4294967295,A=V+(I<<15&4294967295|I>>>17),I=T+(V^(A|~R))+C[5]+4237533241&4294967295,T=A+(I<<21&4294967295|I>>>11),I=R+(A^(T|~V))+C[12]+1700485571&4294967295,R=T+(I<<6&4294967295|I>>>26),I=V+(T^(R|~A))+C[3]+2399980690&4294967295,V=R+(I<<10&4294967295|I>>>22),I=A+(R^(V|~T))+C[10]+4293915773&4294967295,A=V+(I<<15&4294967295|I>>>17),I=T+(V^(A|~R))+C[1]+2240044497&4294967295,T=A+(I<<21&4294967295|I>>>11),I=R+(A^(T|~V))+C[8]+1873313359&4294967295,R=T+(I<<6&4294967295|I>>>26),I=V+(T^(R|~A))+C[15]+4264355552&4294967295,V=R+(I<<10&4294967295|I>>>22),I=A+(R^(V|~T))+C[6]+2734768916&4294967295,A=V+(I<<15&4294967295|I>>>17),I=T+(V^(A|~R))+C[13]+1309151649&4294967295,T=A+(I<<21&4294967295|I>>>11),I=R+(A^(T|~V))+C[4]+4149444226&4294967295,R=T+(I<<6&4294967295|I>>>26),I=V+(T^(R|~A))+C[11]+3174756917&4294967295,V=R+(I<<10&4294967295|I>>>22),I=A+(R^(V|~T))+C[2]+718787259&4294967295,A=V+(I<<15&4294967295|I>>>17),I=T+(V^(A|~R))+C[9]+3951481745&4294967295,D.g[0]=D.g[0]+R&4294967295,D.g[1]=D.g[1]+(A+(I<<21&4294967295|I>>>11))&4294967295,D.g[2]=D.g[2]+A&4294967295,D.g[3]=D.g[3]+V&4294967295}s.prototype.v=function(D,R){R===void 0&&(R=D.length);const T=R-this.blockSize,C=this.C;let A=this.h,V=0;for(;V<R;){if(A==0)for(;V<=T;)o(this,D,V),V+=this.blockSize;if(typeof D=="string"){for(;V<R;)if(C[A++]=D.charCodeAt(V++),A==this.blockSize){o(this,C),A=0;break}}else for(;V<R;)if(C[A++]=D[V++],A==this.blockSize){o(this,C),A=0;break}}this.h=A,this.o+=R},s.prototype.A=function(){var D=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);D[0]=128;for(var R=1;R<D.length-8;++R)D[R]=0;R=this.o*8;for(var T=D.length-8;T<D.length;++T)D[T]=R&255,R/=256;for(this.v(D),D=Array(16),R=0,T=0;T<4;++T)for(let C=0;C<32;C+=8)D[R++]=this.g[T]>>>C&255;return D};function l(D,R){var T=m;return Object.prototype.hasOwnProperty.call(T,D)?T[D]:T[D]=R(D)}function h(D,R){this.h=R;const T=[];let C=!0;for(let A=D.length-1;A>=0;A--){const V=D[A]|0;C&&V==R||(T[A]=V,C=!1)}this.g=T}var m={};function g(D){return-128<=D&&D<128?l(D,function(R){return new h([R|0],R<0?-1:0)}):new h([D|0],D<0?-1:0)}function _(D){if(isNaN(D)||!isFinite(D))return k;if(D<0)return Q(_(-D));const R=[];let T=1;for(let C=0;D>=T;C++)R[C]=D/T|0,T*=4294967296;return new h(R,0)}function E(D,R){if(D.length==0)throw Error("number format error: empty string");if(R=R||10,R<2||36<R)throw Error("radix out of range: "+R);if(D.charAt(0)=="-")return Q(E(D.substring(1),R));if(D.indexOf("-")>=0)throw Error('number format error: interior "-" character');const T=_(Math.pow(R,8));let C=k;for(let V=0;V<D.length;V+=8){var A=Math.min(8,D.length-V);const I=parseInt(D.substring(V,V+A),R);A<8?(A=_(Math.pow(R,A)),C=C.j(A).add(_(I))):(C=C.j(T),C=C.add(_(I)))}return C}var k=g(0),b=g(1),B=g(16777216);r=h.prototype,r.m=function(){if(X(this))return-Q(this).m();let D=0,R=1;for(let T=0;T<this.g.length;T++){const C=this.i(T);D+=(C>=0?C:4294967296+C)*R,R*=4294967296}return D},r.toString=function(D){if(D=D||10,D<2||36<D)throw Error("radix out of range: "+D);if(J(this))return"0";if(X(this))return"-"+Q(this).toString(D);const R=_(Math.pow(D,6));var T=this;let C="";for(;;){const A=be(T,R).g;T=me(T,A.j(R));let V=((T.g.length>0?T.g[0]:T.h)>>>0).toString(D);if(T=A,J(T))return V+C;for(;V.length<6;)V="0"+V;C=V+C}},r.i=function(D){return D<0?0:D<this.g.length?this.g[D]:this.h};function J(D){if(D.h!=0)return!1;for(let R=0;R<D.g.length;R++)if(D.g[R]!=0)return!1;return!0}function X(D){return D.h==-1}r.l=function(D){return D=me(this,D),X(D)?-1:J(D)?0:1};function Q(D){const R=D.g.length,T=[];for(let C=0;C<R;C++)T[C]=~D.g[C];return new h(T,~D.h).add(b)}r.abs=function(){return X(this)?Q(this):this},r.add=function(D){const R=Math.max(this.g.length,D.g.length),T=[];let C=0;for(let A=0;A<=R;A++){let V=C+(this.i(A)&65535)+(D.i(A)&65535),I=(V>>>16)+(this.i(A)>>>16)+(D.i(A)>>>16);C=I>>>16,V&=65535,I&=65535,T[A]=I<<16|V}return new h(T,T[T.length-1]&-2147483648?-1:0)};function me(D,R){return D.add(Q(R))}r.j=function(D){if(J(this)||J(D))return k;if(X(this))return X(D)?Q(this).j(Q(D)):Q(Q(this).j(D));if(X(D))return Q(this.j(Q(D)));if(this.l(B)<0&&D.l(B)<0)return _(this.m()*D.m());const R=this.g.length+D.g.length,T=[];for(var C=0;C<2*R;C++)T[C]=0;for(C=0;C<this.g.length;C++)for(let A=0;A<D.g.length;A++){const V=this.i(C)>>>16,I=this.i(C)&65535,xe=D.i(A)>>>16,nt=D.i(A)&65535;T[2*C+2*A]+=I*nt,ge(T,2*C+2*A),T[2*C+2*A+1]+=V*nt,ge(T,2*C+2*A+1),T[2*C+2*A+1]+=I*xe,ge(T,2*C+2*A+1),T[2*C+2*A+2]+=V*xe,ge(T,2*C+2*A+2)}for(D=0;D<R;D++)T[D]=T[2*D+1]<<16|T[2*D];for(D=R;D<2*R;D++)T[D]=0;return new h(T,0)};function ge(D,R){for(;(D[R]&65535)!=D[R];)D[R+1]+=D[R]>>>16,D[R]&=65535,R++}function Ee(D,R){this.g=D,this.h=R}function be(D,R){if(J(R))throw Error("division by zero");if(J(D))return new Ee(k,k);if(X(D))return R=be(Q(D),R),new Ee(Q(R.g),Q(R.h));if(X(R))return R=be(D,Q(R)),new Ee(Q(R.g),R.h);if(D.g.length>30){if(X(D)||X(R))throw Error("slowDivide_ only works with positive integers.");for(var T=b,C=R;C.l(D)<=0;)T=Me(T),C=Me(C);var A=Pe(T,1),V=Pe(C,1);for(C=Pe(C,2),T=Pe(T,2);!J(C);){var I=V.add(C);I.l(D)<=0&&(A=A.add(T),V=I),C=Pe(C,1),T=Pe(T,1)}return R=me(D,A.j(R)),new Ee(A,R)}for(A=k;D.l(R)>=0;){for(T=Math.max(1,Math.floor(D.m()/R.m())),C=Math.ceil(Math.log(T)/Math.LN2),C=C<=48?1:Math.pow(2,C-48),V=_(T),I=V.j(R);X(I)||I.l(D)>0;)T-=C,V=_(T),I=V.j(R);J(V)&&(V=b),A=A.add(V),D=me(D,I)}return new Ee(A,D)}r.B=function(D){return be(this,D).h},r.and=function(D){const R=Math.max(this.g.length,D.g.length),T=[];for(let C=0;C<R;C++)T[C]=this.i(C)&D.i(C);return new h(T,this.h&D.h)},r.or=function(D){const R=Math.max(this.g.length,D.g.length),T=[];for(let C=0;C<R;C++)T[C]=this.i(C)|D.i(C);return new h(T,this.h|D.h)},r.xor=function(D){const R=Math.max(this.g.length,D.g.length),T=[];for(let C=0;C<R;C++)T[C]=this.i(C)^D.i(C);return new h(T,this.h^D.h)};function Me(D){const R=D.g.length+1,T=[];for(let C=0;C<R;C++)T[C]=D.i(C)<<1|D.i(C-1)>>>31;return new h(T,D.h)}function Pe(D,R){const T=R>>5;R%=32;const C=D.g.length-T,A=[];for(let V=0;V<C;V++)A[V]=R>0?D.i(V+T)>>>R|D.i(V+T+1)<<32-R:D.i(V+T);return new h(A,D.h)}s.prototype.digest=s.prototype.A,s.prototype.reset=s.prototype.u,s.prototype.update=s.prototype.v,iw=s,h.prototype.add=h.prototype.add,h.prototype.multiply=h.prototype.j,h.prototype.modulo=h.prototype.B,h.prototype.compare=h.prototype.l,h.prototype.toNumber=h.prototype.m,h.prototype.toString=h.prototype.toString,h.prototype.getBits=h.prototype.i,h.fromNumber=_,h.fromString=E,xi=h}).apply(typeof Oy<"u"?Oy:typeof self<"u"?self:typeof window<"u"?window:{});var qu=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var sw,Ka,ow,rc,lf,aw,lw,uw;(function(){var r,e=Object.defineProperty;function t(u){u=[typeof globalThis=="object"&&globalThis,u,typeof window=="object"&&window,typeof self=="object"&&self,typeof qu=="object"&&qu];for(var p=0;p<u.length;++p){var y=u[p];if(y&&y.Math==Math)return y}throw Error("Cannot find global object")}var s=t(this);function o(u,p){if(p)e:{var y=s;u=u.split(".");for(var w=0;w<u.length-1;w++){var L=u[w];if(!(L in y))break e;y=y[L]}u=u[u.length-1],w=y[u],p=p(w),p!=w&&p!=null&&e(y,u,{configurable:!0,writable:!0,value:p})}}o("Symbol.dispose",function(u){return u||Symbol("Symbol.dispose")}),o("Array.prototype.values",function(u){return u||function(){return this[Symbol.iterator]()}}),o("Object.entries",function(u){return u||function(p){var y=[],w;for(w in p)Object.prototype.hasOwnProperty.call(p,w)&&y.push([w,p[w]]);return y}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var l=l||{},h=this||self;function m(u){var p=typeof u;return p=="object"&&u!=null||p=="function"}function g(u,p,y){return u.call.apply(u.bind,arguments)}function _(u,p,y){return _=g,_.apply(null,arguments)}function E(u,p){var y=Array.prototype.slice.call(arguments,1);return function(){var w=y.slice();return w.push.apply(w,arguments),u.apply(this,w)}}function k(u,p){function y(){}y.prototype=p.prototype,u.Z=p.prototype,u.prototype=new y,u.prototype.constructor=u,u.Ob=function(w,L,j){for(var Z=Array(arguments.length-2),_e=2;_e<arguments.length;_e++)Z[_e-2]=arguments[_e];return p.prototype[L].apply(w,Z)}}var b=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?u=>u&&AsyncContext.Snapshot.wrap(u):u=>u;function B(u){const p=u.length;if(p>0){const y=Array(p);for(let w=0;w<p;w++)y[w]=u[w];return y}return[]}function J(u,p){for(let w=1;w<arguments.length;w++){const L=arguments[w];var y=typeof L;if(y=y!="object"?y:L?Array.isArray(L)?"array":y:"null",y=="array"||y=="object"&&typeof L.length=="number"){y=u.length||0;const j=L.length||0;u.length=y+j;for(let Z=0;Z<j;Z++)u[y+Z]=L[Z]}else u.push(L)}}class X{constructor(p,y){this.i=p,this.j=y,this.h=0,this.g=null}get(){let p;return this.h>0?(this.h--,p=this.g,this.g=p.next,p.next=null):p=this.i(),p}}function Q(u){h.setTimeout(()=>{throw u},0)}function me(){var u=D;let p=null;return u.g&&(p=u.g,u.g=u.g.next,u.g||(u.h=null),p.next=null),p}class ge{constructor(){this.h=this.g=null}add(p,y){const w=Ee.get();w.set(p,y),this.h?this.h.next=w:this.g=w,this.h=w}}var Ee=new X(()=>new be,u=>u.reset());class be{constructor(){this.next=this.g=this.h=null}set(p,y){this.h=p,this.g=y,this.next=null}reset(){this.next=this.g=this.h=null}}let Me,Pe=!1,D=new ge,R=()=>{const u=Promise.resolve(void 0);Me=()=>{u.then(T)}};function T(){for(var u;u=me();){try{u.h.call(u.g)}catch(y){Q(y)}var p=Ee;p.j(u),p.h<100&&(p.h++,u.next=p.g,p.g=u)}Pe=!1}function C(){this.u=this.u,this.C=this.C}C.prototype.u=!1,C.prototype.dispose=function(){this.u||(this.u=!0,this.N())},C.prototype[Symbol.dispose]=function(){this.dispose()},C.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function A(u,p){this.type=u,this.g=this.target=p,this.defaultPrevented=!1}A.prototype.h=function(){this.defaultPrevented=!0};var V=(function(){if(!h.addEventListener||!Object.defineProperty)return!1;var u=!1,p=Object.defineProperty({},"passive",{get:function(){u=!0}});try{const y=()=>{};h.addEventListener("test",y,p),h.removeEventListener("test",y,p)}catch{}return u})();function I(u){return/^[\s\xa0]*$/.test(u)}function xe(u,p){A.call(this,u?u.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,u&&this.init(u,p)}k(xe,A),xe.prototype.init=function(u,p){const y=this.type=u.type,w=u.changedTouches&&u.changedTouches.length?u.changedTouches[0]:null;this.target=u.target||u.srcElement,this.g=p,p=u.relatedTarget,p||(y=="mouseover"?p=u.fromElement:y=="mouseout"&&(p=u.toElement)),this.relatedTarget=p,w?(this.clientX=w.clientX!==void 0?w.clientX:w.pageX,this.clientY=w.clientY!==void 0?w.clientY:w.pageY,this.screenX=w.screenX||0,this.screenY=w.screenY||0):(this.clientX=u.clientX!==void 0?u.clientX:u.pageX,this.clientY=u.clientY!==void 0?u.clientY:u.pageY,this.screenX=u.screenX||0,this.screenY=u.screenY||0),this.button=u.button,this.key=u.key||"",this.ctrlKey=u.ctrlKey,this.altKey=u.altKey,this.shiftKey=u.shiftKey,this.metaKey=u.metaKey,this.pointerId=u.pointerId||0,this.pointerType=u.pointerType,this.state=u.state,this.i=u,u.defaultPrevented&&xe.Z.h.call(this)},xe.prototype.h=function(){xe.Z.h.call(this);const u=this.i;u.preventDefault?u.preventDefault():u.returnValue=!1};var nt="closure_listenable_"+(Math.random()*1e6|0),Et=0;function ze(u,p,y,w,L){this.listener=u,this.proxy=null,this.src=p,this.type=y,this.capture=!!w,this.ha=L,this.key=++Et,this.da=this.fa=!1}function G(u){u.da=!0,u.listener=null,u.proxy=null,u.src=null,u.ha=null}function ne(u,p,y){for(const w in u)p.call(y,u[w],w,u)}function P(u,p){for(const y in u)p.call(void 0,u[y],y,u)}function q(u){const p={};for(const y in u)p[y]=u[y];return p}const le="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Te(u,p){let y,w;for(let L=1;L<arguments.length;L++){w=arguments[L];for(y in w)u[y]=w[y];for(let j=0;j<le.length;j++)y=le[j],Object.prototype.hasOwnProperty.call(w,y)&&(u[y]=w[y])}}function we(u){this.src=u,this.g={},this.h=0}we.prototype.add=function(u,p,y,w,L){const j=u.toString();u=this.g[j],u||(u=this.g[j]=[],this.h++);const Z=ke(u,p,w,L);return Z>-1?(p=u[Z],y||(p.fa=!1)):(p=new ze(p,this.src,j,!!w,L),p.fa=y,u.push(p)),p};function Ue(u,p){const y=p.type;if(y in u.g){var w=u.g[y],L=Array.prototype.indexOf.call(w,p,void 0),j;(j=L>=0)&&Array.prototype.splice.call(w,L,1),j&&(G(p),u.g[y].length==0&&(delete u.g[y],u.h--))}}function ke(u,p,y,w){for(let L=0;L<u.length;++L){const j=u[L];if(!j.da&&j.listener==p&&j.capture==!!y&&j.ha==w)return L}return-1}var Le="closure_lm_"+(Math.random()*1e6|0),Ne={};function Rt(u,p,y,w,L){if(Array.isArray(p)){for(let j=0;j<p.length;j++)Rt(u,p[j],y,w,L);return null}return y=Go(y),u&&u[nt]?u.J(p,y,m(w)?!!w.capture:!1,L):ih(u,p,y,!1,w,L)}function ih(u,p,y,w,L,j){if(!p)throw Error("Invalid event type");const Z=m(L)?!!L.capture:!!L;let _e=Os(u);if(_e||(u[Le]=_e=new we(u)),y=_e.add(p,y,w,Z,j),y.proxy)return y;if(w=Vs(),y.proxy=w,w.src=u,w.listener=y,u.addEventListener)V||(L=Z),L===void 0&&(L=!1),u.addEventListener(p.toString(),w,L);else if(u.attachEvent)u.attachEvent(bs(p.toString()),w);else if(u.addListener&&u.removeListener)u.addListener(w);else throw Error("addEventListener and attachEvent are unavailable.");return y}function Vs(){function u(y){return p.call(u.src,u.listener,y)}const p=kl;return u}function Ko(u,p,y,w,L){if(Array.isArray(p))for(var j=0;j<p.length;j++)Ko(u,p[j],y,w,L);else w=m(w)?!!w.capture:!!w,y=Go(y),u&&u[nt]?(u=u.i,j=String(p).toString(),j in u.g&&(p=u.g[j],y=ke(p,y,w,L),y>-1&&(G(p[y]),Array.prototype.splice.call(p,y,1),p.length==0&&(delete u.g[j],u.h--)))):u&&(u=Os(u))&&(p=u.g[p.toString()],u=-1,p&&(u=ke(p,y,w,L)),(y=u>-1?p[u]:null)&&Wr(y))}function Wr(u){if(typeof u!="number"&&u&&!u.da){var p=u.src;if(p&&p[nt])Ue(p.i,u);else{var y=u.type,w=u.proxy;p.removeEventListener?p.removeEventListener(y,w,u.capture):p.detachEvent?p.detachEvent(bs(y),w):p.addListener&&p.removeListener&&p.removeListener(w),(y=Os(p))?(Ue(y,u),y.h==0&&(y.src=null,p[Le]=null)):G(u)}}}function bs(u){return u in Ne?Ne[u]:Ne[u]="on"+u}function kl(u,p){if(u.da)u=!0;else{p=new xe(p,this);const y=u.listener,w=u.ha||u.src;u.fa&&Wr(u),u=y.call(w,p)}return u}function Os(u){return u=u[Le],u instanceof we?u:null}var zi="__closure_events_fn_"+(Math.random()*1e9>>>0);function Go(u){return typeof u=="function"?u:(u[zi]||(u[zi]=function(p){return u.handleEvent(p)}),u[zi])}function ht(){C.call(this),this.i=new we(this),this.M=this,this.G=null}k(ht,C),ht.prototype[nt]=!0,ht.prototype.removeEventListener=function(u,p,y,w){Ko(this,u,p,y,w)};function ot(u,p){var y,w=u.G;if(w)for(y=[];w;w=w.G)y.push(w);if(u=u.M,w=p.type||p,typeof p=="string")p=new A(p,u);else if(p instanceof A)p.target=p.target||u;else{var L=p;p=new A(w,u),Te(p,L)}L=!0;let j,Z;if(y)for(Z=y.length-1;Z>=0;Z--)j=p.g=y[Z],L=Cn(j,w,!0,p)&&L;if(j=p.g=u,L=Cn(j,w,!0,p)&&L,L=Cn(j,w,!1,p)&&L,y)for(Z=0;Z<y.length;Z++)j=p.g=y[Z],L=Cn(j,w,!1,p)&&L}ht.prototype.N=function(){if(ht.Z.N.call(this),this.i){var u=this.i;for(const p in u.g){const y=u.g[p];for(let w=0;w<y.length;w++)G(y[w]);delete u.g[p],u.h--}}this.G=null},ht.prototype.J=function(u,p,y,w){return this.i.add(String(u),p,!1,y,w)},ht.prototype.K=function(u,p,y,w){return this.i.add(String(u),p,!0,y,w)};function Cn(u,p,y,w){if(p=u.i.g[String(p)],!p)return!0;p=p.concat();let L=!0;for(let j=0;j<p.length;++j){const Z=p[j];if(Z&&!Z.da&&Z.capture==y){const _e=Z.listener,at=Z.ha||Z.src;Z.fa&&Ue(u.i,Z),L=_e.call(at,w)!==!1&&L}}return L&&!w.defaultPrevented}function Qo(u,p){if(typeof u!="function")if(u&&typeof u.handleEvent=="function")u=_(u.handleEvent,u);else throw Error("Invalid listener argument");return Number(p)>2147483647?-1:h.setTimeout(u,p||0)}function Yo(u){u.g=Qo(()=>{u.g=null,u.i&&(u.i=!1,Yo(u))},u.l);const p=u.h;u.h=null,u.m.apply(null,p)}class Cl extends C{constructor(p,y){super(),this.m=p,this.l=y,this.h=null,this.i=!1,this.g=null}j(p){this.h=arguments,this.g?this.i=!0:Yo(this)}N(){super.N(),this.g&&(h.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Kr(u){C.call(this),this.h=u,this.g={}}k(Kr,C);var Jo=[];function Ms(u){ne(u.g,function(p,y){this.g.hasOwnProperty(y)&&Wr(p)},u),u.g={}}Kr.prototype.N=function(){Kr.Z.N.call(this),Ms(this)},Kr.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Gr=h.JSON.stringify,Pl=h.JSON.parse,$i=class{stringify(u){return h.JSON.stringify(u,void 0)}parse(u){return h.JSON.parse(u,void 0)}};function Qr(){}function xl(){}var Yr={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Ls(){A.call(this,"d")}k(Ls,A);function Xo(){A.call(this,"c")}k(Xo,A);var Pn={},Fs=null;function Jr(){return Fs=Fs||new ht}Pn.Ia="serverreachability";function Us(u){A.call(this,Pn.Ia,u)}k(Us,A);function gr(u){const p=Jr();ot(p,new Us(p))}Pn.STAT_EVENT="statevent";function yr(u,p){A.call(this,Pn.STAT_EVENT,u),this.stat=p}k(yr,A);function rt(u){const p=Jr();ot(p,new yr(p,u))}Pn.Ja="timingevent";function Zo(u,p){A.call(this,Pn.Ja,u),this.size=p}k(Zo,A);function Xr(u,p){if(typeof u!="function")throw Error("Fn must not be null and must be a function");return h.setTimeout(function(){u()},p)}function Zr(){this.g=!0}Zr.prototype.ua=function(){this.g=!1};function Nl(u,p,y,w,L,j){u.info(function(){if(u.g)if(j){var Z="",_e=j.split("&");for(let Be=0;Be<_e.length;Be++){var at=_e[Be].split("=");if(at.length>1){const dt=at[0];at=at[1];const ln=dt.split("_");Z=ln.length>=2&&ln[1]=="type"?Z+(dt+"="+at+"&"):Z+(dt+"=redacted&")}}}else Z=null;else Z=j;return"XMLHTTP REQ ("+w+") [attempt "+L+"]: "+p+`
`+y+`
`+Z})}function Dl(u,p,y,w,L,j,Z){u.info(function(){return"XMLHTTP RESP ("+w+") [ attempt "+L+"]: "+p+`
`+y+`
`+j+" "+Z})}function $n(u,p,y,w){u.info(function(){return"XMLHTTP TEXT ("+p+"): "+qi(u,y)+(w?" "+w:"")})}function Vl(u,p){u.info(function(){return"TIMEOUT: "+p})}Zr.prototype.info=function(){};function qi(u,p){if(!u.g)return p;if(!p)return null;try{const j=JSON.parse(p);if(j){for(u=0;u<j.length;u++)if(Array.isArray(j[u])){var y=j[u];if(!(y.length<2)){var w=y[1];if(Array.isArray(w)&&!(w.length<1)){var L=w[0];if(L!="noop"&&L!="stop"&&L!="close")for(let Z=1;Z<w.length;Z++)w[Z]=""}}}}return Gr(j)}catch{return p}}var ei={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},ti={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},bl;function _r(){}k(_r,Qr),_r.prototype.g=function(){return new XMLHttpRequest},bl=new _r;function qn(u){return encodeURIComponent(String(u))}function js(u){var p=1;u=u.split(":");const y=[];for(;p>0&&u.length;)y.push(u.shift()),p--;return u.length&&y.push(u.join(":")),y}function mn(u,p,y,w){this.j=u,this.i=p,this.l=y,this.S=w||1,this.V=new Kr(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new Ol}function Ol(){this.i=null,this.g="",this.h=!1}var Ml={},ea={};function xn(u,p,y){u.M=1,u.A=wr(gn(p)),u.u=y,u.R=!0,ta(u,null)}function ta(u,p){u.F=Date.now(),Hi(u),u.B=gn(u.A);var y=u.B,w=u.S;Array.isArray(w)||(w=[String(w)]),ha(y.i,"t",w),u.C=0,y=u.j.L,u.h=new Ol,u.g=Wl(u.j,y?p:null,!u.u),u.P>0&&(u.O=new Cl(_(u.Y,u,u.g),u.P)),p=u.V,y=u.g,w=u.ba;var L="readystatechange";Array.isArray(L)||(L&&(Jo[0]=L.toString()),L=Jo);for(let j=0;j<L.length;j++){const Z=Rt(y,L[j],w||p.handleEvent,!1,p.h||p);if(!Z)break;p.g[Z.key]=Z}p=u.J?q(u.J):{},u.u?(u.v||(u.v="POST"),p["Content-Type"]="application/x-www-form-urlencoded",u.g.ea(u.B,u.v,u.u,p)):(u.v="GET",u.g.ea(u.B,u.v,null,p)),gr(),Nl(u.i,u.v,u.B,u.l,u.S,u.u)}mn.prototype.ba=function(u){u=u.target;const p=this.O;p&&Jn(u)==3?p.j():this.Y(u)},mn.prototype.Y=function(u){try{if(u==this.g)e:{const _e=Jn(this.g),at=this.g.ya(),Be=this.g.ca();if(!(_e<3)&&(_e!=3||this.g&&(this.h.h||this.g.la()||ql(this.g)))){this.K||_e!=4||at==7||(at==8||Be<=0?gr(3):gr(2)),Bs(this);var p=this.g.ca();this.X=p;var y=Ll(this);if(this.o=p==200,Dl(this.i,this.v,this.B,this.l,this.S,_e,p),this.o){if(this.U&&!this.L){t:{if(this.g){var w,L=this.g;if((w=L.g?L.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!I(w)){var j=w;break t}}j=null}if(u=j)$n(this.i,this.l,u,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Ke(this,u);else{this.o=!1,this.m=3,rt(12),vr(this),Wi(this);break e}}if(this.R){u=!0;let dt;for(;!this.K&&this.C<y.length;)if(dt=Ul(this,y),dt==ea){_e==4&&(this.m=4,rt(14),u=!1),$n(this.i,this.l,null,"[Incomplete Response]");break}else if(dt==Ml){this.m=4,rt(15),$n(this.i,this.l,y,"[Invalid Chunk]"),u=!1;break}else $n(this.i,this.l,dt,null),Ke(this,dt);if(Fl(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),_e!=4||y.length!=0||this.h.h||(this.m=1,rt(16),u=!1),this.o=this.o&&u,!u)$n(this.i,this.l,y,"[Invalid Chunked Response]"),vr(this),Wi(this);else if(y.length>0&&!this.W){this.W=!0;var Z=this.j;Z.g==this&&Z.aa&&!Z.P&&(Z.j.info("Great, no buffering proxy detected. Bytes received: "+y.length),ts(Z),Z.P=!0,rt(11))}}else $n(this.i,this.l,y,null),Ke(this,y);_e==4&&vr(this),this.o&&!this.K&&(_e==4?Js(this.j,this):(this.o=!1,Hi(this)))}else fa(this.g),p==400&&y.indexOf("Unknown SID")>0?(this.m=3,rt(12)):(this.m=0,rt(13)),vr(this),Wi(this)}}}catch{}finally{}};function Ll(u){if(!Fl(u))return u.g.la();const p=ql(u.g);if(p==="")return"";let y="";const w=p.length,L=Jn(u.g)==4;if(!u.h.i){if(typeof TextDecoder>"u")return vr(u),Wi(u),"";u.h.i=new h.TextDecoder}for(let j=0;j<w;j++)u.h.h=!0,y+=u.h.i.decode(p[j],{stream:!(L&&j==w-1)});return p.length=0,u.h.g+=y,u.C=0,u.h.g}function Fl(u){return u.g?u.v=="GET"&&u.M!=2&&u.j.Aa:!1}function Ul(u,p){var y=u.C,w=p.indexOf(`
`,y);return w==-1?ea:(y=Number(p.substring(y,w)),isNaN(y)?Ml:(w+=1,w+y>p.length?ea:(p=p.slice(w,w+y),u.C=w+y,p)))}mn.prototype.cancel=function(){this.K=!0,vr(this)};function Hi(u){u.T=Date.now()+u.H,na(u,u.H)}function na(u,p){if(u.D!=null)throw Error("WatchDog timer not null");u.D=Xr(_(u.aa,u),p)}function Bs(u){u.D&&(h.clearTimeout(u.D),u.D=null)}mn.prototype.aa=function(){this.D=null;const u=Date.now();u-this.T>=0?(Vl(this.i,this.B),this.M!=2&&(gr(),rt(17)),vr(this),this.m=2,Wi(this)):na(this,this.T-u)};function Wi(u){u.j.I==0||u.K||Js(u.j,u)}function vr(u){Bs(u);var p=u.O;p&&typeof p.dispose=="function"&&p.dispose(),u.O=null,Ms(u.V),u.g&&(p=u.g,u.g=null,p.abort(),p.dispose())}function Ke(u,p){try{var y=u.j;if(y.I!=0&&(y.g==u||ia(y.h,u))){if(!u.L&&ia(y.h,u)&&y.I==3){try{var w=y.Ba.g.parse(p)}catch{w=null}if(Array.isArray(w)&&w.length==3){var L=w;if(L[0]==0){e:if(!y.v){if(y.g)if(y.g.F+3e3<u.F)Ys(y),on(y);else break e;er(y),rt(18)}}else y.xa=L[1],0<y.xa-y.K&&L[2]<37500&&y.F&&y.A==0&&!y.C&&(y.C=Xr(_(y.Va,y),6e3));Ki(y.h)<=1&&y.ta&&(y.ta=void 0)}else an(y,11)}else if((u.L||y.g==u)&&Ys(y),!I(p))for(L=y.Ba.g.parse(p),p=0;p<L.length;p++){let Be=L[p];const dt=Be[0];if(!(dt<=y.K))if(y.K=dt,Be=Be[1],y.I==2)if(Be[0]=="c"){y.M=Be[1],y.ba=Be[2];const ln=Be[3];ln!=null&&(y.ka=ln,y.j.info("VER="+y.ka));const Ar=Be[4];Ar!=null&&(y.za=Ar,y.j.info("SVER="+y.za));const tr=Be[5];tr!=null&&typeof tr=="number"&&tr>0&&(w=1.5*tr,y.O=w,y.j.info("backChannelRequestTimeoutMs_="+w)),w=y;const nr=u.g;if(nr){const eo=nr.g?nr.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(eo){var j=w.h;j.g||eo.indexOf("spdy")==-1&&eo.indexOf("quic")==-1&&eo.indexOf("h2")==-1||(j.j=j.l,j.g=new Set,j.h&&($s(j,j.h),j.h=null))}if(w.G){const ga=nr.g?nr.g.getResponseHeader("X-HTTP-Session-Id"):null;ga&&(w.wa=ga,Fe(w.J,w.G,ga))}}y.I=3,y.l&&y.l.ra(),y.aa&&(y.T=Date.now()-u.F,y.j.info("Handshake RTT: "+y.T+"ms")),w=y;var Z=u;if(w.na=ma(w,w.L?w.ba:null,w.W),Z.L){Gi(w.h,Z);var _e=Z,at=w.O;at&&(_e.H=at),_e.D&&(Bs(_e),Hi(_e)),w.g=Z}else bt(w);y.i.length>0&&Sr(y)}else Be[0]!="stop"&&Be[0]!="close"||an(y,7);else y.I==3&&(Be[0]=="stop"||Be[0]=="close"?Be[0]=="stop"?an(y,7):Gs(y):Be[0]!="noop"&&y.l&&y.l.qa(Be),y.A=0)}}gr(4)}catch{}}var sh=class{constructor(u,p){this.g=u,this.map=p}};function zs(u){this.l=u||10,h.PerformanceNavigationTiming?(u=h.performance.getEntriesByType("navigation"),u=u.length>0&&(u[0].nextHopProtocol=="hq"||u[0].nextHopProtocol=="h2")):u=!!(h.chrome&&h.chrome.loadTimes&&h.chrome.loadTimes()&&h.chrome.loadTimes().wasFetchedViaSpdy),this.j=u?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function ra(u){return u.h?!0:u.g?u.g.size>=u.j:!1}function Ki(u){return u.h?1:u.g?u.g.size:0}function ia(u,p){return u.h?u.h==p:u.g?u.g.has(p):!1}function $s(u,p){u.g?u.g.add(p):u.h=p}function Gi(u,p){u.h&&u.h==p?u.h=null:u.g&&u.g.has(p)&&u.g.delete(p)}zs.prototype.cancel=function(){if(this.i=nn(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const u of this.g.values())u.cancel();this.g.clear()}};function nn(u){if(u.h!=null)return u.i.concat(u.h.G);if(u.g!=null&&u.g.size!==0){let p=u.i;for(const y of u.g.values())p=p.concat(y.G);return p}return B(u.i)}var jl=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function rn(u,p){if(u){u=u.split("&");for(let y=0;y<u.length;y++){const w=u[y].indexOf("=");let L,j=null;w>=0?(L=u[y].substring(0,w),j=u[y].substring(w+1)):L=u[y],p(L,j?decodeURIComponent(j.replace(/\+/g," ")):"")}}}function Hn(u){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let p;u instanceof Hn?(this.l=u.l,Qi(this,u.j),this.o=u.o,this.g=u.g,Wn(this,u.u),this.h=u.h,ni(this,da(u.i)),this.m=u.m):u&&(p=String(u).match(jl))?(this.l=!1,Qi(this,p[1]||"",!0),this.o=Yi(p[2]||""),this.g=Yi(p[3]||"",!0),Wn(this,p[4]),this.h=Yi(p[5]||"",!0),ni(this,p[6]||"",!0),this.m=Yi(p[7]||"")):(this.l=!1,this.i=new Ce(null,this.l))}Hn.prototype.toString=function(){const u=[];var p=this.j;p&&u.push(Ji(p,oa,!0),":");var y=this.g;return(y||p=="file")&&(u.push("//"),(p=this.o)&&u.push(Ji(p,oa,!0),"@"),u.push(qn(y).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),y=this.u,y!=null&&u.push(":",String(y))),(y=this.h)&&(this.g&&y.charAt(0)!="/"&&u.push("/"),u.push(Ji(y,y.charAt(0)=="/"?Xi:aa,!0))),(y=this.i.toString())&&u.push("?",y),(y=this.m)&&u.push("#",Ji(y,la)),u.join("")},Hn.prototype.resolve=function(u){const p=gn(this);let y=!!u.j;y?Qi(p,u.j):y=!!u.o,y?p.o=u.o:y=!!u.g,y?p.g=u.g:y=u.u!=null;var w=u.h;if(y)Wn(p,u.u);else if(y=!!u.h){if(w.charAt(0)!="/")if(this.g&&!this.h)w="/"+w;else{var L=p.h.lastIndexOf("/");L!=-1&&(w=p.h.slice(0,L+1)+w)}if(L=w,L==".."||L==".")w="";else if(L.indexOf("./")!=-1||L.indexOf("/.")!=-1){w=L.lastIndexOf("/",0)==0,L=L.split("/");const j=[];for(let Z=0;Z<L.length;){const _e=L[Z++];_e=="."?w&&Z==L.length&&j.push(""):_e==".."?((j.length>1||j.length==1&&j[0]!="")&&j.pop(),w&&Z==L.length&&j.push("")):(j.push(_e),w=!0)}w=j.join("/")}else w=L}return y?p.h=w:y=u.i.toString()!=="",y?ni(p,da(u.i)):y=!!u.m,y&&(p.m=u.m),p};function gn(u){return new Hn(u)}function Qi(u,p,y){u.j=y?Yi(p,!0):p,u.j&&(u.j=u.j.replace(/:$/,""))}function Wn(u,p){if(p){if(p=Number(p),isNaN(p)||p<0)throw Error("Bad port number "+p);u.u=p}else u.u=null}function ni(u,p,y){p instanceof Ce?(u.i=p,Hs(u.i,u.l)):(y||(p=Ji(p,oh)),u.i=new Ce(p,u.l))}function Fe(u,p,y){u.i.set(p,y)}function wr(u){return Fe(u,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),u}function Yi(u,p){return u?p?decodeURI(u.replace(/%25/g,"%2525")):decodeURIComponent(u):""}function Ji(u,p,y){return typeof u=="string"?(u=encodeURI(u).replace(p,sa),y&&(u=u.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),u):null}function sa(u){return u=u.charCodeAt(0),"%"+(u>>4&15).toString(16)+(u&15).toString(16)}var oa=/[#\/\?@]/g,aa=/[#\?:]/g,Xi=/[#\?]/g,oh=/[#\?@]/g,la=/#/g;function Ce(u,p){this.h=this.g=null,this.i=u||null,this.j=!!p}function Kn(u){u.g||(u.g=new Map,u.h=0,u.i&&rn(u.i,function(p,y){u.add(decodeURIComponent(p.replace(/\+/g," ")),y)}))}r=Ce.prototype,r.add=function(u,p){Kn(this),this.i=null,u=Gn(this,u);let y=this.g.get(u);return y||this.g.set(u,y=[]),y.push(p),this.h+=1,this};function ua(u,p){Kn(u),p=Gn(u,p),u.g.has(p)&&(u.i=null,u.h-=u.g.get(p).length,u.g.delete(p))}function qs(u,p){return Kn(u),p=Gn(u,p),u.g.has(p)}r.forEach=function(u,p){Kn(this),this.g.forEach(function(y,w){y.forEach(function(L){u.call(p,L,w,this)},this)},this)};function ca(u,p){Kn(u);let y=[];if(typeof p=="string")qs(u,p)&&(y=y.concat(u.g.get(Gn(u,p))));else for(u=Array.from(u.g.values()),p=0;p<u.length;p++)y=y.concat(u[p]);return y}r.set=function(u,p){return Kn(this),this.i=null,u=Gn(this,u),qs(this,u)&&(this.h-=this.g.get(u).length),this.g.set(u,[p]),this.h+=1,this},r.get=function(u,p){return u?(u=ca(this,u),u.length>0?String(u[0]):p):p};function ha(u,p,y){ua(u,p),y.length>0&&(u.i=null,u.g.set(Gn(u,p),B(y)),u.h+=y.length)}r.toString=function(){if(this.i)return this.i;if(!this.g)return"";const u=[],p=Array.from(this.g.keys());for(let w=0;w<p.length;w++){var y=p[w];const L=qn(y);y=ca(this,y);for(let j=0;j<y.length;j++){let Z=L;y[j]!==""&&(Z+="="+qn(y[j])),u.push(Z)}}return this.i=u.join("&")};function da(u){const p=new Ce;return p.i=u.i,u.g&&(p.g=new Map(u.g),p.h=u.h),p}function Gn(u,p){return p=String(p),u.j&&(p=p.toLowerCase()),p}function Hs(u,p){p&&!u.j&&(Kn(u),u.i=null,u.g.forEach(function(y,w){const L=w.toLowerCase();w!=L&&(ua(this,w),ha(this,L,y))},u)),u.j=p}function Qn(u,p){const y=new Zr;if(h.Image){const w=new Image;w.onload=E(kt,y,"TestLoadImage: loaded",!0,p,w),w.onerror=E(kt,y,"TestLoadImage: error",!1,p,w),w.onabort=E(kt,y,"TestLoadImage: abort",!1,p,w),w.ontimeout=E(kt,y,"TestLoadImage: timeout",!1,p,w),h.setTimeout(function(){w.ontimeout&&w.ontimeout()},1e4),w.src=u}else p(!1)}function Yn(u,p){const y=new Zr,w=new AbortController,L=setTimeout(()=>{w.abort(),kt(y,"TestPingServer: timeout",!1,p)},1e4);fetch(u,{signal:w.signal}).then(j=>{clearTimeout(L),j.ok?kt(y,"TestPingServer: ok",!0,p):kt(y,"TestPingServer: server error",!1,p)}).catch(()=>{clearTimeout(L),kt(y,"TestPingServer: error",!1,p)})}function kt(u,p,y,w,L){try{L&&(L.onload=null,L.onerror=null,L.onabort=null,L.ontimeout=null),w(y)}catch{}}function Zi(){this.g=new $i}function Er(u){this.i=u.Sb||null,this.h=u.ab||!1}k(Er,Qr),Er.prototype.g=function(){return new sn(this.i,this.h)};function sn(u,p){ht.call(this),this.H=u,this.o=p,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}k(sn,ht),r=sn.prototype,r.open=function(u,p){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=u,this.D=p,this.readyState=1,Nn(this)},r.send=function(u){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const p={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};u&&(p.body=u),(this.H||h).fetch(new Request(this.D,p)).then(this.Pa.bind(this),this.ga.bind(this))},r.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,ri(this)),this.readyState=0},r.Pa=function(u){if(this.g&&(this.l=u,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=u.headers,this.readyState=2,Nn(this)),this.g&&(this.readyState=3,Nn(this),this.g)))if(this.responseType==="arraybuffer")u.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof h.ReadableStream<"u"&&"body"in u){if(this.j=u.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;Bl(this)}else u.text().then(this.Oa.bind(this),this.ga.bind(this))};function Bl(u){u.j.read().then(u.Ma.bind(u)).catch(u.ga.bind(u))}r.Ma=function(u){if(this.g){if(this.o&&u.value)this.response.push(u.value);else if(!this.o){var p=u.value?u.value:new Uint8Array(0);(p=this.B.decode(p,{stream:!u.done}))&&(this.response=this.responseText+=p)}u.done?ri(this):Nn(this),this.readyState==3&&Bl(this)}},r.Oa=function(u){this.g&&(this.response=this.responseText=u,ri(this))},r.Na=function(u){this.g&&(this.response=u,ri(this))},r.ga=function(){this.g&&ri(this)};function ri(u){u.readyState=4,u.l=null,u.j=null,u.B=null,Nn(u)}r.setRequestHeader=function(u,p){this.A.append(u,p)},r.getResponseHeader=function(u){return this.h&&this.h.get(u.toLowerCase())||""},r.getAllResponseHeaders=function(){if(!this.h)return"";const u=[],p=this.h.entries();for(var y=p.next();!y.done;)y=y.value,u.push(y[0]+": "+y[1]),y=p.next();return u.join(`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dl{constructor(e,t="asc"){this.field=e,this.dir=t}}function a1(r,e){return r.dir===e.dir&&r.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I1=new tt(ue.comparator);function $r(){return I1}const Vw=new tt(ue.comparator);function Ga(...r){let e=Vw;for(const t of r)e=e.insert(t.key,t);return e}function bw(r){let e=Vw;return r.forEach(((t,s)=>e=e.insert(t,s.overlayedDocument))),e}function ys(){return tl()}function Ow(){return tl()}function tl(){return new Ns((r=>r.toString()),((r,e)=>r.isEqual(e)))}const S1=new tt(ue.comparator),A1=new wt(ue.comparator);function Re(...r){let e=A1;for(const t of r)e=e.add(t);return e}const R1=new wt(Ae);function k1(){return R1}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jf(r,e){if(r.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:vc(e)?"-0":e}}function Mw(r){return{integerValue:""+r}}function C1(r,e){return Xk(e)?Mw(e):Jf(r,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wc{constructor(){this._=void 0}}function P1(r,e,t){return r instanceof Sc?(function(o,l){const h={fields:{[_w]:{stringValue:yw},[ww]:{timestampValue:{seconds:o.seconds,nanos:o.nanoseconds}}}};return l&&Kf(l)&&(l=zc(l)),l&&(h.fields[vw]=l),{mapValue:h}})(t,e):r instanceof fl?Fw(r,e):r instanceof pl?Uw(r,e):(function(o,l){const h=Lw(o,l),m=e_(h)+e_(o.Ae);return hf(h)&&hf(o.Ae)?Mw(m):Jf(o.serializer,m)})(r,e)}function x1(r,e,t){return r instanceof fl?Fw(r,e):r instanceof pl?Uw(r,e):t}function Lw(r,e){return r instanceof Ac?(function(s){return hf(s)||(function(l){return!!l&&"doubleValue"in l})(s)})(e)?e:{integerValue:0}:null}class Sc extends Wc{}class fl extends Wc{constructor(e){super(),this.elements=e}}function Fw(r,e){const t=jw(e);for(const s of r.elements)t.some((o=>pr(o,s)))||t.push(s);return{arrayValue:{values:t}}}class pl extends Wc{constructor(e){super(),this.elements=e}}function Uw(r,e){let t=jw(e);for(const s of r.elements)t=t.filter((o=>!pr(o,s)));return{arrayValue:{values:t}}}class Ac extends Wc{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function e_(r){return ut(r.integerValue||r.doubleValue)}function jw(r){return Gf(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}function N1(r,e){return r.field.isEqual(e.field)&&(function(s,o){return s instanceof fl&&o instanceof fl||s instanceof pl&&o instanceof pl?bo(s.elements,o.elements,pr):s instanceof Ac&&o instanceof Ac?pr(s.Ae,o.Ae):s instanceof Sc&&o instanceof Sc})(r.transform,e.transform)}class D1{constructor(e,t){this.version=e,this.transformResults=t}}class kn{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new kn}static exists(e){return new kn(void 0,e)}static updateTime(e){return new kn(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function oc(r,e){return r.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(r.updateTime):r.exists===void 0||r.exists===e.isFoundDocument()}class Kc{}function Bw(r,e){if(!r.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return r.isNoDocument()?new Xf(r.key,kn.none()):new Tl(r.key,r.data,kn.none());{const t=r.data,s=en.empty();let o=new wt(Dt.comparator);for(let l of e.fields)if(!o.has(l)){let h=t.field(l);h===null&&l.length>1&&(l=l.popLast(),h=t.field(l)),h===null?s.delete(l):s.set(l,h),o=o.add(l)}return new Bi(r.key,s,new pn(o.toArray()),kn.none())}}function V1(r,e,t){r instanceof Tl?(function(o,l,h){const m=o.value.clone(),g=n_(o.fieldTransforms,l,h.transformResults);m.setAll(g),l.convertToFoundDocument(h.version,m).setHasCommittedMutations()})(r,e,t):r instanceof Bi?(function(o,l,h){if(!oc(o.precondition,l))return void l.convertToUnknownDocument(h.version);const m=n_(o.fieldTransforms,l,h.transformResults),g=l.data;g.setAll(zw(o)),g.setAll(m),l.convertToFoundDocument(h.version,g).setHasCommittedMutations()})(r,e,t):(function(o,l,h){l.convertToNoDocument(h.version).setHasCommittedMutations()})(0,e,t)}function nl(r,e,t,s){return r instanceof Tl?(function(l,h,m,g){if(!oc(l.precondition,h))return m;const _=l.value.clone(),E=r_(l.fieldTransforms,g,h);return _.setAll(E),h.convertToFoundDocument(h.version,_).setHasLocalMutations(),null})(r,e,t,s):r instanceof Bi?(function(l,h,m,g){if(!oc(l.precondition,h))return m;const _=r_(l.fieldTransforms,g,h),E=h.data;return E.setAll(zw(l)),E.setAll(_),h.convertToFoundDocument(h.version,E).setHasLocalMutations(),m===null?null:m.unionWith(l.fieldMask.fields).unionWith(l.fieldTransforms.map((k=>k.field)))})(r,e,t,s):(function(l,h,m){return oc(l.precondition,h)?(h.convertToNoDocument(h.version).setHasLocalMutations(),null):m})(r,e,t)}function b1(r,e){let t=null;for(const s of r.fieldTransforms){const o=e.data.field(s.field),l=Lw(s.transform,o||null);l!=null&&(t===null&&(t=en.empty()),t.set(s.field,l))}return t||null}function t_(r,e){return r.type===e.type&&!!r.key.isEqual(e.key)&&!!r.precondition.isEqual(e.precondition)&&!!(function(s,o){return s===void 0&&o===void 0||!(!s||!o)&&bo(s,o,((l,h)=>N1(l,h)))})(r.fieldTransforms,e.fieldTransforms)&&(r.type===0?r.value.isEqual(e.value):r.type!==1||r.data.isEqual(e.data)&&r.fieldMask.isEqual(e.fieldMask))}class Tl extends Kc{constructor(e,t,s,o=[]){super(),this.key=e,this.value=t,this.precondition=s,this.fieldTransforms=o,this.type=0}getFieldMask(){return null}}class Bi extends Kc{constructor(e,t,s,o,l=[]){super(),this.key=e,this.data=t,this.fieldMask=s,this.precondition=o,this.fieldTransforms=l,this.type=1}getFieldMask(){return this.fieldMask}}function zw(r){const e=new Map;return r.fieldMask.fields.forEach((t=>{if(!t.isEmpty()){const s=r.data.field(t);e.set(t,s)}})),e}function n_(r,e,t){const s=new Map;je(r.length===t.length,32656,{Ve:t.length,de:r.length});for(let o=0;o<t.length;o++){const l=r[o],h=l.transform,m=e.data.field(l.field);s.set(l.field,x1(h,m,t[o]))}return s}function r_(r,e,t){const s=new Map;for(const o of r){const l=o.transform,h=t.data.field(o.field);s.set(o.field,P1(l,h,e))}return s}class Xf extends Kc{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class O1 extends Kc{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gc{constructor(e,t,s,o,l){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=s,this.documentUpdates=o,this.resolvedLimboDocuments=l}static createSynthesizedRemoteEventForCurrentChange(e,t,s){const o=new Map;return o.set(e,Il.createSynthesizedTargetChangeForCurrentChange(e,t,s)),new Gc(ye.min(),o,new tt(Ae),$r(),Re())}}class Il{constructor(e,t,s,o,l){this.resumeToken=e,this.current=t,this.addedDocuments=s,this.modifiedDocuments=o,this.removedDocuments=l}static createSynthesizedTargetChangeForCurrentChange(e,t,s){return new Il(s,t,Re(),Re(),Re())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yC{constructor(e,t,s,o){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=s,this.indexManager=o}getDocument(e,t){let s=null;return this.documentOverlayCache.getOverlay(e,t).next((o=>(s=o,this.remoteDocumentCache.getEntry(e,t)))).next((o=>(s!==null&&nl(s.mutation,o,pn.empty(),Ye.now()),o)))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next((s=>this.getLocalViewOfDocuments(e,s,Re()).next((()=>s))))}getLocalViewOfDocuments(e,t,s=Re()){const o=ys();return this.populateOverlays(e,o,t).next((()=>this.computeViews(e,t,o,s).next((l=>{let h=Ga();return l.forEach(((m,g)=>{h=h.insert(m,g.overlayedDocument)})),h}))))}getOverlayedDocuments(e,t){const s=ys();return this.populateOverlays(e,s,t).next((()=>this.computeViews(e,t,s,Re())))}populateOverlays(e,t,s){const o=[];return s.forEach((l=>{t.has(l)||o.push(l)})),this.documentOverlayCache.getOverlays(e,o).next((l=>{l.forEach(((h,m)=>{t.set(h,m)}))}))}computeViews(e,t,s,o){let l=$r();const h=tl(),m=(function(){return tl()})();return t.forEach(((g,_)=>{const E=s.get(_.key);o.has(_.key)&&(E===void 0||E.mutation instanceof Bi)?l=l.insert(_.key,_):E!==void 0?(h.set(_.key,E.mutation.getFieldMask()),nl(E.mutation,_,E.mutation.getFieldMask(),Ye.now())):h.set(_.key,pn.empty())})),this.recalculateAndSaveOverlays(e,l).next((g=>(g.forEach(((_,E)=>h.set(_,E))),t.forEach(((_,E)=>m.set(_,new gC(E,h.get(_)??null)))),m)))}recalculateAndSaveOverlays(e,t){const s=tl();let o=new tt(((h,m)=>h-m)),l=Re();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next((h=>{for(const m of h)m.keys().forEach((g=>{const _=t.get(g);if(_===null)return;let E=s.get(g)||pn.empty();E=m.applyToLocalView(_,E),s.set(g,E);const k=(o.get(m.batchId)||Re()).add(g);o=o.insert(m.batchId,k)}))})).next((()=>{const h=[],m=o.getReverseIterator();for(;m.hasNext();){const g=m.getNext(),_=g.key,E=g.value,k=Ow();E.forEach((b=>{if(!l.has(b)){const B=Bw(t.get(b),s.get(b));B!==null&&k.set(b,B),l=l.add(b)}})),h.push(this.documentOverlayCache.saveOverlays(e,_,k))}return $.waitFor(h)})).next((()=>s))}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next((s=>this.recalculateAndSaveOverlays(e,s)))}getDocumentsMatchingQuery(e,t,s,o){return _1(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):xw(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,s,o):this.getDocumentsMatchingCollectionQuery(e,t,s,o)}getNextDocuments(e,t,s,o){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,s,o).next((l=>{const h=o-l.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,s.largestBatchId,o-l.size):$.resolve(ys());let m=ll,g=l;return h.next((_=>$.forEach(_,((E,k)=>(m<k.largestBatchId&&(m=k.largestBatchId),l.get(E)?$.resolve():this.remoteDocumentCache.getEntry(e,E).next((b=>{g=g.insert(E,b)}))))).next((()=>this.populateOverlays(e,_,l))).next((()=>this.computeViews(e,g,_,Re()))).next((E=>({batchId:m,changes:bw(E)})))))}))}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new ue(t)).next((s=>{let o=Ga();return s.isFoundDocument()&&(o=o.insert(s.key,s)),o}))}getDocumentsMatchingCollectionGroupQuery(e,t,s,o){const l=t.collectionGroup;let h=Ga();return this.indexManager.getCollectionParents(e,l).next((m=>$.forEach(m,(g=>{const _=(function(k,b){return new Ho(b,null,k.explicitOrderBy.slice(),k.filters.slice(),k.limit,k.limitType,k.startAt,k.endAt)})(t,g.child(l));return this.getDocumentsMatchingCollectionQuery(e,_,s,o).next((E=>{E.forEach(((k,b)=>{h=h.insert(k,b)}))}))})).next((()=>h))))}getDocumentsMatchingCollectionQuery(e,t,s,o){let l;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,s.largestBatchId).next((h=>(l=h,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,s,l,o)))).next((h=>{l.forEach(((g,_)=>{const E=_.getKey();h.get(E)===null&&(h=h.insert(E,zt.newInvalidDocument(E)))}));let m=Ga();return h.forEach(((g,_)=>{const E=l.get(g);E!==void 0&&nl(E.mutation,_,pn.empty(),Ye.now()),Hc(t,_)&&(m=m.insert(g,_))})),m}))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gd="RestConnection",UC={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class jC{get qo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),o=encodeURIComponent(this.databaseId.database);this.Ko=t+"://"+e.host,this.Uo=`projects/${s}/databases/${o}`,this.$o=this.databaseId.database===wc?`project_id=${s}`:`project_id=${s}&database_id=${o}`}Wo(e,t,s,o,l){const h=wf(),m=this.Qo(e,t.toUriEncodedString());re(Gd,`Sending RPC '${e}' ${h}:`,m,s);const g={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.$o};this.Go(g,o,l);const{host:_}=new URL(m),E=gl(_);return this.zo(e,m,g,s,E).then((k=>(re(Gd,`Received RPC '${e}' ${h}: `,k),k)),(k=>{throw Rs(Gd,`RPC '${e}' ${h} failed with error: `,k,"url: ",m,"request:",s),k}))}jo(e,t,s,o,l,h){return this.Wo(e,t,s,o,l)}Go(e,t,s){e["X-Goog-Api-Client"]=(function(){return"gl-js/ fire/"+zo})(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach(((o,l)=>e[l]=o)),s&&s.headers.forEach(((o,l)=>e[l]=o))}Qo(e,t){const s=UC[e];let o=`${this.Ko}/v1/${t}:${s}`;return this.databaseInfo.apiKey&&(o=`${o}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),o}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ut="WebChannelConnection",za=(r,e,t)=>{r.listen(e,(s=>{try{t(s)}catch(o){setTimeout((()=>{throw o}),0)}}))};class Do extends jC{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!Do.c_){const e=lw();za(e,aw.STAT_EVENT,(t=>{t.stat===lf.PROXY?re(Ut,"STAT_EVENT: detected buffering proxy"):t.stat===lf.NOPROXY&&re(Ut,"STAT_EVENT: detected no buffering proxy")})),Do.c_=!0}}zo(e,t,s,o,l){const h=wf();return new Promise(((m,g)=>{const _=new sw;_.setWithCredentials(!0),_.listenOnce(ow.COMPLETE,(()=>{try{switch(_.getLastErrorCode()){case rc.NO_ERROR:const k=_.getResponseJson();re(Ut,`XHR for RPC '${e}' ${h} received:`,JSON.stringify(k)),m(k);break;case rc.TIMEOUT:re(Ut,`RPC '${e}' ${h} timed out`),g(new ee(z.DEADLINE_EXCEEDED,"Request time out"));break;case rc.HTTP_ERROR:const b=_.getStatus();if(re(Ut,`RPC '${e}' ${h} failed with status:`,b,"response text:",_.getResponseText()),b>0){let B=_.getResponseJson();Array.isArray(B)&&(B=B[0]);const J=B==null?void 0:B.error;if(J&&J.status&&J.message){const X=(function(me){const ge=me.toLowerCase().replace(/_/g,"-");return Object.values(z).indexOf(ge)>=0?ge:z.UNKNOWN})(J.status);g(new ee(X,J.message))}else g(new ee(z.UNKNOWN,"Server responded with status "+_.getStatus()))}else g(new ee(z.UNAVAILABLE,"Connection failed."));break;default:fe(9055,{l_:e,streamId:h,h_:_.getLastErrorCode(),P_:_.getLastError()})}}finally{re(Ut,`RPC '${e}' ${h} completed.`)}}));const E=JSON.stringify(o);re(Ut,`RPC '${e}' ${h} sending request:`,o),_.send(t,"POST",E,s,15)}))}T_(e,t,s){const o=wf(),l=[this.Ko,"/","google.firestore.v1.Firestore","/",e,"/channel"],h=this.createWebChannelTransport(),m={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},g=this.longPollingOptions.timeoutSeconds;g!==void 0&&(m.longPollingTimeout=Math.round(1e3*g)),this.useFetchStreams&&(m.useFetchStreams=!0),this.Go(m.initMessageHeaders,t,s),m.encodeInitMessageHeaders=!0;const _=l.join("");re(Ut,`Creating RPC '${e}' stream ${o}: ${_}`,m);const E=h.createWebChannel(_,m);this.E_(E);let k=!1,b=!1;const B=new BC({Jo:J=>{b?re(Ut,`Not sending because RPC '${e}' stream ${o} is closed:`,J):(k||(re(Ut,`Opening RPC '${e}' stream ${o} transport.`),E.open(),k=!0),re(Ut,`RPC '${e}' stream ${o} sending:`,J),E.send(J))},Ho:()=>E.close()});return za(E,Ka.EventType.OPEN,(()=>{b||(re(Ut,`RPC '${e}' stream ${o} transport opened.`),B.i_())})),za(E,Ka.EventType.CLOSE,(()=>{b||(b=!0,re(Ut,`RPC '${e}' stream ${o} transport closed`),B.o_(),this.I_(E))})),za(E,Ka.EventType.ERROR,(J=>{b||(b=!0,Rs(Ut,`RPC '${e}' stream ${o} transport errored. Name:`,J.name,"Message:",J.message),B.o_(new ee(z.UNAVAILABLE,"The operation could not be completed")))})),za(E,Ka.EventType.MESSAGE,(J=>{var X;if(!b){const Q=J.data[0];je(!!Q,16349);const me=Q,ge=(me==null?void 0:me.error)||((X=me[0])==null?void 0:X.error);if(ge){re(Ut,`RPC '${e}' stream ${o} received error:`,ge);const Ee=ge.status;let be=(function(D){const R=pt[D];if(R!==void 0)return $w(R)})(Ee),Me=ge.message;Ee==="NOT_FOUND"&&Me.includes("database")&&Me.includes("does not exist")&&Me.includes(this.databaseId.database)&&Rs(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),be===void 0&&(be=z.INTERNAL,Me="Unknown error status: "+Ee+" with message "+ge.message),b=!0,B.o_(new ee(be,Me)),E.close()}else re(Ut,`RPC '${e}' stream ${o} received:`,Q),B.__(Q)}})),Do.u_(),setTimeout((()=>{B.s_()}),0),B}terminate(){this.a_.forEach((e=>e.close())),this.a_=[]}E_(e){this.a_.push(e)}I_(e){this.a_=this.a_.filter((t=>t===e))}Go(e,t,s){super.Go(e,t,s),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return uw()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const MP="ComponentProvider",S_=new Map;function LP(r,e,t,s,o){return new n1(r,e,t,o.host,o.ssl,o.experimentalForceLongPolling,o.experimentalAutoDetectLongPolling,EE(o.experimentalLongPollingOptions),o.useFetchStreams,o.isUsingEmulator,s)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dr{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new ee(z.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new ee(z.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return Ae(this._lat,e._lat)||Ae(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:dr._jsonSchemaVersion}}static fromJSON(e){if(El(e,dr._jsonSchema))return new dr(e.latitude,e.longitude)}}dr._jsonSchemaVersion="firestore/geoPoint/1.0",dr._jsonSchema={type:gt("string",dr._jsonSchemaVersion),latitude:gt("number"),longitude:gt("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function JP(r){r=tn(r,st);const e=tn(r.firestore,qr),t=Zc(e);return VP(t,r._key).then((s=>OE(e,r,s)))}function To(r){r=tn(r,Hr);const e=tn(r.firestore,qr),t=Zc(e),s=new Ip(e);return NE(r._query),bP(t,r._query).then((o=>new vs(e,s,r,o)))}function XP(r,e,t){r=tn(r,st);const s=tn(r.firestore,qr),o=bE(r.converter,e),l=eh(s);return rh(s,[AE(l,"setDoc",r._key,o,r.converter!==null,t).toMutation(r._key,kn.none())])}function $a(r,e,t,...s){r=tn(r,st);const o=tn(r.firestore,qr),l=eh(o);let h;return h=typeof(e=ct(e))=="string"||e instanceof vp?HP(l,"updateDoc",r._key,e,t,s):qP(l,"updateDoc",r._key,e),rh(o,[h.toMutation(r._key,kn.exists(!0))])}function Qu(r){return rh(tn(r.firestore,qr),[new Xf(r._key,kn.none())])}function Yu(r,e){const t=tn(r.firestore,qr),s=In(r),o=bE(r.converter,e),l=eh(r.firestore);return rh(t,[AE(l,"addDoc",s._key,o,r.converter!==null,{}).toMutation(s._key,kn.exists(!1))]).then((()=>s))}function qa(r,...e){var _,E,k;r=ct(r);let t={includeMetadataChanges:!1,source:"default"},s=0;typeof e[s]!="object"||D_(e[s])||(t=e[s++]);const o={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(D_(e[s])){const b=e[s];e[s]=(_=b.next)==null?void 0:_.bind(b),e[s+1]=(E=b.error)==null?void 0:E.bind(b),e[s+2]=(k=b.complete)==null?void 0:k.bind(b)}let l,h,m;if(r instanceof st)h=tn(r.firestore,qr),m=$c(r._key.path),l={next:b=>{e[s]&&e[s](OE(h,r,b))},error:e[s+1],complete:e[s+2]};else{const b=tn(r,Hr);h=tn(b.firestore,qr),m=b._query;const B=new Ip(h);l={next:J=>{e[s]&&e[s](new vs(h,B,b,J))},error:e[s+1],complete:e[s+2]},NE(r._query)}const g=Zc(h);return DP(g,m,o,l)}function rh(r,e){const t=Zc(r);return OP(t,e)}function OE(r,e,t){const s=t.docs.get(e._key),o=new Ip(r);return new _s(r,o,e._key,s,new Ya(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){bk(jo),fr(new jn("firestore",((s,{instanceIdentifier:o,options:l})=>{const h=s.getProvider("app").getImmediate(),m=new qr(new Lk(s.getProvider("auth-internal")),new jk(h,s.getProvider("app-check-internal")),r1(h,o),h);return l={useFetchStreams:t,...l},m._setSettings(l),m}),"PUBLIC").setMultipleInstances(!0)),Rn(x_,N_,e),Rn(x_,N_,"esm2020")})();const ZP={apiKey:"AIzaSyDuxT03D9vxSWE5Fw29sdsnCohTtGj32fo",authDomain:"ipreu-95300.firebaseapp.com",projectId:"ipreu-95300",storageBucket:"ipreu-95300.firebasestorage.app",messagingSenderId:"921313347665",appId:"1:921313347665:web:128cdbb3e428b113a71070"},Pp=J_(ZP),ko=iR(Pp),qe=UP(Pp),Ju=typeof window<"u"?Nk(Pp):null,xp="uc_token",Np="uc_user";function O_(r,e){try{localStorage.setItem(xp,r),localStorage.setItem(Np,JSON.stringify(e))}catch(t){console.error("Failed to save session",t)}}function ex(){try{const r=localStorage.getItem(xp),e=localStorage.getItem(Np);return{token:r,user:e?JSON.parse(e):null}}catch{return{token:null,user:null}}}function tx(){try{localStorage.removeItem(xp),localStorage.removeItem(Np),ec(ko).catch(console.error)}catch(r){console.error("Failed to clear session",r)}}const vt={login:async(r,e)=>{if(!e)throw new Error("Password required");const t=await HS(ko,r,e),s=await JP(In(qe,"users",t.user.uid));if(!s.exists())throw await ec(ko),new Error("User record not found in database.");const o={id:s.id,...s.data()};if(o.role==="PENDING")throw await ec(ko),new Error("Your application is still pending approval. Please check back later.");return{token:await t.user.getIdToken(),user:o}},register:async r=>{if(!r.password)throw new Error("Password required");if(!r.email)throw new Error("Email required");const e=r.email.toLowerCase().trim(),t=await qS(ko,e,r.password),{password:s,...o}=r;return o.email=e,await XP(In(qe,"users",t.user.uid),{...o,role:"PENDING",createdAt:new Date().toISOString()}),await ec(ko),!0},getAnnouncements:async()=>{const r=fn(jt(qe,"announcements"),Ci("createdAt","desc"),DE(30));return(await To(r)).docs.map(t=>({id:t.id,...t.data()}))},createAnnouncement:async r=>{const e=new Date().toISOString();return{id:(await Yu(jt(qe,"announcements"),{...r,createdAt:e})).id,...r,createdAt:e}},deleteAnnouncement:async r=>(await Qu(In(qe,"announcements",r)),!0),updateAnnouncement:async(r,e)=>(await $a(In(qe,"announcements",r),e),!0),getPendingUsers:async()=>{const r=fn(jt(qe,"users"),lc("role","==","PENDING"));return(await To(r)).docs.map(t=>({id:t.id,...t.data()}))},getApprovedUsers:async()=>{const r=fn(jt(qe,"users"),lc("role","==","MEMBER"));return(await To(r)).docs.map(t=>({id:t.id,...t.data()}))},approveUser:async r=>(await $a(In(qe,"users",r),{role:"MEMBER"}),!0),rejectUser:async r=>(await Qu(In(qe,"users",r)),!0),getSurveys:async()=>{const r=fn(jt(qe,"surveys"));return(await To(r)).docs.map(t=>({id:t.id,...t.data()}))},createSurvey:async r=>({id:(await Yu(jt(qe,"surveys"),r)).id,...r}),deleteSurvey:async r=>(await Qu(In(qe,"surveys",r)),!0),updateSurvey:async(r,e)=>(await $a(In(qe,"surveys",r),e),!0),getCalendarEvents:async()=>{const r=fn(jt(qe,"calendar"),Ci("date","asc"));return(await To(r)).docs.map(t=>({id:t.id,...t.data()}))},createCalendarEvent:async r=>({id:(await Yu(jt(qe,"calendar"),r)).id,...r}),deleteCalendarEvent:async r=>(await Qu(In(qe,"calendar",r)),!0),getGrievances:async r=>{let e;const t=jt(qe,"grievances");return r?e=fn(t,lc("userId","==",r),Ci("createdAt","desc")):e=fn(t,Ci("createdAt","desc")),(await To(e)).docs.map(o=>({id:o.id,...o.data()}))},createGrievance:async r=>({id:(await Yu(jt(qe,"grievances"),r)).id,...r}),updateGrievance:async(r,e)=>(await $a(In(qe,"grievances",r),e),!0),saveFcmToken:async(r,e)=>{const t=In(qe,"users",r);await $a(t,{fcmToken:e})}},M_=et.lazy(()=>Af(()=>import("./Auth-0NuZFkQt.js"),[])),nx=et.lazy(()=>Af(()=>import("./AdminDashboard-CdYO2krW.js"),__vite__mapDeps([0,1]))),rx=et.lazy(()=>Af(()=>import("./MemberDashboard-B9ir8MM2.js"),__vite__mapDeps([2,1]))),ME=et.createContext(null),LE=()=>{const r=et.useContext(ME);if(!r)throw new Error("useAppContext must be used within AppProvider");return r};function ix(){const[r,e]=et.useState(!0),[t,s]=et.useState(!1),[o,l]=et.useState(()=>localStorage.getItem("theme")==="dark"),[h,m]=et.useState(null),[g,_]=et.useState([]),[E,k]=et.useState([]),[b,B]=et.useState([]),[J,X]=et.useState([]),[Q,me]=et.useState([]),[ge,Ee]=et.useState("dashboard"),[be,Me]=et.useState(null);F_.useLayoutEffect(()=>{document.documentElement.classList.toggle("dark",o),localStorage.setItem("theme",o?"dark":"light")},[o]),et.useEffect(()=>{const T={dashboard:"My Dashboard | IPREU",calendar:"Union Calendar | IPREU",grievances:"Secure Grievances | IPREU",overview:"Admin Overview | IPREU",members:"Manage Users | IPREU",announcements:"Broadcast | IPREU"};document.title=T[ge]||"IPREU Union Connect"},[ge]),et.useEffect(()=>{(async()=>{try{const C=ex();C&&C.user&&(m(C.user),Pe(C.user.id))}catch(C){console.error("Session init failed:",C)}finally{e(!1)}})()},[]),et.useEffect(()=>{if(!h)return;const T=fn(jt(qe,"announcements"),Ci("createdAt","desc"),DE(30)),C=qa(T,G=>{k(G.docs.map(ne=>({id:ne.id,...ne.data()})))},G=>console.error("Announcements Sync Error:",G)),A=fn(jt(qe,"surveys")),V=qa(A,G=>{_(G.docs.map(ne=>({id:ne.id,...ne.data()})))},G=>console.error("Surveys Sync Error:",G)),I=fn(jt(qe,"calendar"),Ci("date","asc")),xe=qa(I,G=>{B(G.docs.map(ne=>({id:ne.id,...ne.data()})))},G=>console.error("Calendar Sync Error:",G));let nt;h.role==="ADMIN"?nt=fn(jt(qe,"grievances"),Ci("createdAt","desc")):nt=fn(jt(qe,"grievances"),lc("userId","==",h.id),Ci("createdAt","desc"));const Et=qa(nt,G=>{X(G.docs.map(ne=>({id:ne.id,...ne.data()})))},G=>console.error("Grievances Sync Error:",G));let ze=()=>{};if(h.role==="ADMIN"){const G=fn(jt(qe,"users"));ze=qa(G,ne=>{me(ne.docs.map(P=>({id:P.id,...P.data()})))})}return()=>{C(),V(),xe(),Et(),ze()}},[h==null?void 0:h.id]);const Pe=async T=>{if(Ju)try{if(await Notification.requestPermission()==="granted"){const A=await Dk(Ju,{vapidKey:"BKZqsvNJwZbljTyY0T6ho_GruW2LiC8WBEre2uMqg6A-67sBHoF2RIg6VCX2BLMs0LVolggQTCap4zwDgedyKjI"});A&&await vt.saveFcmToken(T,A)}}catch(C){console.error("FCM Registration failed:",C)}};et.useEffect(()=>{if(!Ju)return;const T=Vk(Ju,C=>{var A,V;alert(`Notification: ${(A=C.notification)==null?void 0:A.title}
${(V=C.notification)==null?void 0:V.body}`)});return()=>T()},[]);const D=et.useMemo(()=>({currentUser:h,isDarkMode:o,toggleDarkMode:()=>l(T=>!T),users:Q,surveys:g,announcements:E,calendarEvents:b,grievances:J,fetchAnnouncements:async()=>{const T=await vt.getAnnouncements();k(T)},memberLogin:async(T,C)=>{var A;try{const V=await vt.login(T,C);return V.token&&V.user&&V.user.role==="MEMBER"?(m(V.user),O_(V.token,V.user),{success:!0}):{success:!1,error:"Access denied. Only members can login here."}}catch(V){return(A=V.message)!=null&&A.includes("pending approval")?{success:!1,pending:!0}:{success:!1,error:V.message||"Login failed"}}},adminLogin:async(T,C)=>{try{const A=await vt.login(T,C);if(A.token&&A.user&&A.user.role==="ADMIN"){m(A.user),O_(A.token,A.user);const[V,I]=await Promise.all([vt.getPendingUsers(),vt.getApprovedUsers()]);return me([...V,...I]),{success:!0}}return{success:!1,error:"Access denied. Only admins can login here."}}catch(A){return{success:!1,error:A.message||"Admin login failed"}}},logout:()=>{m(null),tx()},register:async T=>(await vt.register(T),!0),approveRegistration:async T=>{await vt.approveUser(T),me(C=>C.map(A=>A.id===T?{...A,role:Ja.MEMBER}:A))},rejectRegistration:async T=>{await vt.rejectUser(T),me(C=>C.filter(A=>A.id!==T))},createSurvey:async T=>{const C=await vt.createSurvey({...T,votes:{}});_(A=>[C,...A])},deleteSurvey:async T=>{await vt.deleteSurvey(T),_(C=>C.filter(A=>A.id!==T))},submitVote:async(T,C)=>{if(!h)return;const A=g.find(I=>I.id===T);if(!A)return;const V={...A.votes,[h.id]:C};await vt.updateSurvey(T,{votes:V}),_(I=>I.map(xe=>xe.id===T?{...xe,votes:V}:xe))},createAnnouncement:async(T,C,A)=>{const V=await vt.createAnnouncement({title:T,content:C,attachment:A??void 0});k(I=>[V,...I])},updateAnnouncement:async(T,C,A)=>{await vt.updateAnnouncement(T,{title:C,content:A}),k(V=>V.map(I=>I.id===T?{...I,title:C,content:A}:I))},deleteAnnouncement:async T=>{await vt.deleteAnnouncement(T),k(C=>C.filter(A=>A.id!==T))},createCalendarEvent:async T=>{const C=await vt.createCalendarEvent({...T,createdAt:new Date().toISOString()});B(A=>[...A,C])},deleteCalendarEvent:async T=>{await vt.deleteCalendarEvent(T),B(C=>C.filter(A=>A.id!==T))},submitGrievance:async(T,C,A)=>{if(!h)return;const V={userId:h.id,userName:h.employeeName,subject:T,description:C,category:A,status:"NEW",createdAt:new Date().toISOString()},I=await vt.createGrievance(V);X(xe=>[I,...xe])},respondToGrievance:async(T,C)=>{const A={response:C,respondedAt:new Date().toISOString(),status:"RESOLVED"};await vt.updateGrievance(T,A),X(V=>V.map(I=>I.id===T?{...I,...A}:I))}}),[h,Q,g,E,b,J,o]),R=()=>{if(!h)return t?N.jsx(M_,{onBack:()=>s(!1)}):N.jsx(hT,{onLoginClick:T=>{T&&Me(T),s(!0)}});switch(be&&(Ee(be),Me(null)),h.role){case Ja.ADMIN:return N.jsx(nx,{activeTab:ge,setActiveTab:Ee});case Ja.MEMBER:return N.jsx(rx,{activeTab:ge,setActiveTab:Ee});default:return N.jsx(M_,{onBack:()=>s(!1)})}};return r?N.jsx("div",{className:"min-h-screen flex items-center justify-center bg-[#fcfaf7] transition-colors duration-300",children:N.jsx("div",{className:"animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-orange-600 shadow-[0_0_20px_rgba(234,88,12,0.3)]"})}):N.jsx(ME.Provider,{value:D,children:N.jsxs("div",{className:"min-h-screen font-sans bg-[#fcfaf7] transition-colors duration-300",children:[N.jsx(iT,{}),N.jsx("main",{className:"container mx-auto p-4 md:p-8 pb-32",children:N.jsx(et.Suspense,{fallback:N.jsx("div",{className:"min-h-[50vh] flex items-center justify-center",children:N.jsx("div",{className:"animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-orange-600"})}),children:R()})}),h&&N.jsx("footer",{className:"w-full py-12 bg-white/5 border-t border-orange-100 backdrop-blur-sm mt-auto",children:N.jsx("div",{className:"container mx-auto px-4",children:N.jsx(U_,{})})})]})})}const FE=document.getElementById("root");if(!FE)throw new Error("Could not find root element to mount to");const sx=eT.createRoot(FE);sx.render(N.jsx(F_.StrictMode,{children:N.jsx(ix,{})}));export{aT as C,ox as I,sT as M,lT as P,Ja as U,rT as a,N as j,et as r,LE as u};
